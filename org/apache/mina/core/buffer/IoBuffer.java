...
public abstract class IoBuffer implements Comparable<IoBuffer> {
    ...
    public abstract String getPrefixedString(int i, CharsetDecoder charsetDecoder);

    public abstract String getPrefixedString(CharsetDecoder charsetDecoder);
    ...
    public abstract String getString(int i, CharsetDecoder charsetDecoder);

    public abstract String getString(CharsetDecoder charsetDecoder);
    ...
    public abstract IoBuffer putPrefixedString(CharSequence charSequence, int i, int i2, byte b, CharsetEncoder charsetEncoder);

    public abstract IoBuffer putPrefixedString(CharSequence charSequence, int i, int i2, CharsetEncoder charsetEncoder);

    public abstract IoBuffer putPrefixedString(CharSequence charSequence, int i, CharsetEncoder charsetEncoder);

    public abstract IoBuffer putPrefixedString(CharSequence charSequence, CharsetEncoder charsetEncoder);

    public abstract IoBuffer putShort(int i, short s);

    public abstract IoBuffer putShort(short s);

    public abstract IoBuffer putString(CharSequence charSequence, int i, CharsetEncoder charsetEncoder);

    public abstract IoBuffer putString(CharSequence charSequence, CharsetEncoder charsetEncoder);
