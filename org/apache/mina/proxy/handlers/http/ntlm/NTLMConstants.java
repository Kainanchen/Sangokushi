...
public interface NTLMConstants {
    ...
    public static final byte[] DEFAULT_OS_VERSION;
    ...
    public static final byte[] NTLM_SIGNATURE;
    public static final short TARGET_INFORMATION_SUBBLOCK_DNS_DOMAIN_NAME_TYPE = (short) 1024;
    public static final short TARGET_INFORMATION_SUBBLOCK_DOMAIN_TYPE = (short) 512;
    public static final short TARGET_INFORMATION_SUBBLOCK_FQDNS_HOSTNAME_TYPE = (short) 768;
    public static final short TARGET_INFORMATION_SUBBLOCK_PARENT_DNS_DOMAIN_NAME_TYPE = (short) 1280;
    public static final short TARGET_INFORMATION_SUBBLOCK_SERVER_TYPE = (short) 256;
    public static final short TARGET_INFORMATION_SUBBLOCK_TERMINATOR_TYPE = (short) 0;

    static {
        NTLM_SIGNATURE = new byte[]{(byte) 78, (byte) 84, (byte) 76, (byte) 77, (byte) 83, (byte) 83, (byte) 80, (byte) 0};
        DEFAULT_OS_VERSION = new byte[]{(byte) 5, (byte) 1, (byte) 40, (byte) 10, (byte) 0, (byte) 0, (byte) 0, (byte) 15};
    }
}
