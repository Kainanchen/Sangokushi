...
public enum HttpAuthenticationMethods {
    ...
    public final AbstractAuthLogicHandler getNewHandler(ProxyIoSession proxyIoSession) {
        return getNewHandler(this.id, proxyIoSession);
    }

    public static AbstractAuthLogicHandler getNewHandler(int i, ProxyIoSession proxyIoSession) {
        if (i == BASIC.id) {
