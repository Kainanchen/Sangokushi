...
class VmPipeSession extends AbstractIoSession {
    ...
    static {
        boolean z = false;
        METADATA = new DefaultTransportMetadata("mina", "vmpipe", false, z, VmPipeAddress.class, VmPipeSessionConfig.class, Object.class);
    }
    ...
    void increaseWrittenBytes0(int i, long j) {
