...
class AccessibilityManagerCompatIcs {
    ...
    static class C00271 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00271(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
