...
class KeyframeSet {
    ...
    public static KeyframeSet ofInt(int... iArr) {
        ...
        if (length == 1) {
            ...
            intKeyframeArr[1] = (IntKeyframe) Keyframe.ofInt(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, iArr[0]);
        } else {
    ...
    public static KeyframeSet ofFloat(float... fArr) {
        ...
        if (length == 1) {
            ...
            floatKeyframeArr[1] = (FloatKeyframe) Keyframe.ofFloat(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, fArr[0]);
        } else {
    ...
    public static KeyframeSet ofObject(Object... objArr) {
        ...
        if (length == 1) {
            ...
            keyframeArr[1] = (ObjectKeyframe) Keyframe.ofObject(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, objArr[0]);
        } else {
