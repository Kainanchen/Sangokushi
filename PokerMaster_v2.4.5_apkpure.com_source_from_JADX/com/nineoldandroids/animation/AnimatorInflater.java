...
public class AnimatorInflater {
    ...
    private static ValueAnimator loadAnimator(Context context, AttributeSet attributeSet, ValueAnimator valueAnimator) {
        ...
        if (obj != null) {
            ...
            if (obj2 != null) {
                float dimension2;
                if (i2 == Animator_valueFrom) {
                    dimension2 = obtainStyledAttributes.getDimension(Animator_valueFrom, 0.0f);
                } else {
                    dimension2 = obtainStyledAttributes.getFloat(Animator_valueFrom, 0.0f);
                }
                if (obj3 != null) {
                    if (i3 == Animator_valueFrom) {
                        dimension = obtainStyledAttributes.getDimension(Animator_valueTo, 0.0f);
                    } else {
                        dimension = obtainStyledAttributes.getFloat(Animator_valueTo, 0.0f);
                    }
                    float[] fArr = new float[Animator_startOffset];
                    fArr[Animator_interpolator] = dimension2;
                    fArr[Animator_duration] = dimension;
                    valueAnimator.setFloatValues(fArr);
                } else {
                    float[] fArr2 = new float[Animator_duration];
                    fArr2[Animator_interpolator] = dimension2;
                ...
                fArr3[Animator_interpolator] = dimension;
                valueAnimator.setFloatValues(fArr3);
            }
        } else if (obj2 != null) {
            if (i2 == Animator_valueFrom) {
                i2 = (int) obtainStyledAttributes.getDimension(Animator_valueFrom, 0.0f);
            } else if (i2 < 28 || i2 > 31) {
                i2 = obtainStyledAttributes.getInt(Animator_valueFrom, Animator_interpolator);
            } else {
                i2 = obtainStyledAttributes.getColor(Animator_valueFrom, Animator_interpolator);
            }
            if (obj3 != null) {
                if (i3 == Animator_valueFrom) {
                    i = (int) obtainStyledAttributes.getDimension(Animator_valueTo, 0.0f);
                } else if (i3 < 28 || i3 > 31) {
                    i = obtainStyledAttributes.getInt(Animator_valueTo, Animator_interpolator);
                } else {
                    i = obtainStyledAttributes.getColor(Animator_valueTo, Animator_interpolator);
                }
