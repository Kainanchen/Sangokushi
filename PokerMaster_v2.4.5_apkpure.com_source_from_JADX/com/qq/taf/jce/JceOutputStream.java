...
public class JceOutputStream {
    ...
    public JceOutputStream() {
        this((int) AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
    }
    ...
    public void writeHead(byte b, int i) {
        ...
        } else if (i < AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY) {
    ...
    public void writeStringByte(String str, int i) {
        ...
        if (hexStr2Bytes.length > MotionEventCompat.ACTION_MASK) {
            writeHead((byte) 7, i);
    ...
    public void write(String str, int i) {
        ...
        if (bytes.length > MotionEventCompat.ACTION_MASK) {
            writeHead((byte) 7, i);
