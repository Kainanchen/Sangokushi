...
public final class JceUtil {
    ...
    public static int hashCode(double[] dArr) {
        ...
        for (int i2 = 0; i2 < dArr.length; i2++) {
            i = (i * iConstant) + ((int) (Double.doubleToLongBits(dArr[i2]) ^ (Double.doubleToLongBits(dArr[i2]) >> 32)));
        }
        return i;
    }
    ...
    public static int hashCode(float[] fArr) {
        ...
        for (float floatToIntBits : fArr) {
            i = (i * iConstant) + Float.floatToIntBits(floatToIntBits);
        }
        return i;
    }
    ...
    public static int hashCode(long[] jArr) {
        ...
        for (int i2 = 0; i2 < jArr.length; i2++) {
            i = (i * iConstant) + ((int) (jArr[i2] ^ (jArr[i2] >> 32)));
        }
        return i;
    }
    ...
    public static int hashCode(JceStruct[] jceStructArr) {
        ...
        for (Object hashCode : jceStructArr) {
            i = (i * iConstant) + hashCode.hashCode();
        }
        return i;
    }
    ...
    static {
        ...
        for (int i = 0; i < AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY; i++) {
            bArr2[i] = bArr[i >>> 4];
            bArr3[i] = bArr[i & 15];
        }
        highDigits = bArr2;
