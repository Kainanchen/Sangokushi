...
public class ImageLoader {
    ...
    class C02662 implements Listener<Bitmap> {
    ...
    class C02673 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    public static ImageListener getImageListener(ImageView imageView, int i, int i2) {
        return new C02651(i2, imageView, i);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String str, int i, int i2, ScaleType scaleType, String str2) {
        return new ImageRequest(str, new C02662(str2), i, i2, scaleType, Config.RGB_565, new C02673(str2));
    }
