...
class RopeByteString extends ByteString {
    ...
    private static class Balancer {
        ...
        private ByteString balance(ByteString byteString, ByteString byteString2) {
            ...
            while (!this.prefixesStack.isEmpty()) {
                byteString3 = new RopeByteString(byteString3, null);
            }
            return byteString3;
        }
        ...
        private void insert(ByteString byteString) {
            ...
            while (!this.prefixesStack.isEmpty() && ((ByteString) this.prefixesStack.peek()).size() < i2) {
                byteString2 = new RopeByteString(byteString2, null);
            }
            byteString2 = new RopeByteString(byteString, null);
            while (!this.prefixesStack.isEmpty()) {
    ...
    static ByteString concatenate(ByteString byteString, ByteString byteString2) {
        ...
        if (size < AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS) {
            return concatenateBytes(byteString, byteString2);
        }
        if (ropeByteString != null && ropeByteString.right.size() + byteString2.size() < AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS) {
    ...
    private boolean equalsFragments(ByteString byteString) {
        Iterator pieceIterator = new PieceIterator(null);
        LiteralByteString literalByteString = (LiteralByteString) pieceIterator.next();
        Iterator pieceIterator2 = new PieceIterator(null);
        ...
        while (true) {
            ...
            if (!(i2 == 0 ? literalByteString3.equalsRange(literalByteString2, i, min) : literalByteString2.equalsRange(literalByteString3, i2, min))) {
                return false;
            }
            int i4 = i3 + min;
