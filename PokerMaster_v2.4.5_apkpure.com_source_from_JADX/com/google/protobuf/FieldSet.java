...
final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    private static void verifyType(FieldType fieldType, Object obj) {
        ...
        switch (C03061.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, boolean z) {
        switch (C03061.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case SQLiteDatabase.OPEN_READONLY /*1*/:
