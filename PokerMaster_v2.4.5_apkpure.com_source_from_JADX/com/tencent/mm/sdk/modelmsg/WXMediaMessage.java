...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            try {
                ...
                e.printStackTrace();
                C1090b.m5874b(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e.getMessage());
                return wXMediaMessage;
            }
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            C1090b.m5874b(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }
        ...
        private static String pathOldToNew(String str) {
            ...
            C1090b.m5874b(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
            return str;
        }
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            e.printStackTrace();
            C1090b.m5874b(TAG, "put thumb failed");
        }
    }
}
