...
final class C1109f extends AsyncTask<Void, Void, C1108a> {
    ...
    static class C1108a {
        ...
        public static com.tencent.mm.sdk.diffdev.p089a.C1109f.C1108a m5901e(byte[] r8) {
            /*
            r7 = 1;
            r6 = 0;
        ...
        L_0x0018:
            ...
            switch(r1) {
                case 402: goto L_0x0091;
                case 403: goto L_0x0097;
    ...
    public C1109f(String str, OAuthListener oAuthListener) {
        this.aq = str;
    ...
    protected final /* synthetic */ Object doInBackground(Object[] objArr) {
        if (this.aq == null || this.aq.length() == 0) {
            ...
            c1108a.ap = OAuthErrCode.WechatAuth_Err_NormalErr;
            return c1108a;
        }
        while (!isCancelled()) {
            String str = this.url + (this.aw == 0 ? LetterIndexBar.SEARCH_ICON_LETTER : "&last=" + this.aw);
            long currentTimeMillis = System.currentTimeMillis();
            byte[] b = C1107e.m5900b(str, 60000);
            long currentTimeMillis2 = System.currentTimeMillis();
            c1108a = C1108a.m5901e(b);
            String.format("nooping, url = %s, errCode = %s, uuidStatusCode = %d, time consumed = %d(ms)", new Object[]{str, c1108a.ap.toString(), Integer.valueOf(c1108a.ay), Long.valueOf(currentTimeMillis2 - currentTimeMillis)});
            if (c1108a.ap == OAuthErrCode.WechatAuth_Err_OK) {
                this.aw = c1108a.ay;
                if (c1108a.ay == C1110g.UUID_SCANED.getCode()) {
                    this.an.onQrcodeScanned();
                } else if (c1108a.ay != C1110g.UUID_KEEP_CONNECT.getCode() && c1108a.ay == C1110g.UUID_CONFIRM.getCode()) {
                    if (c1108a.ax != null && c1108a.ax.length() != 0) {
                        return c1108a;
                    }
            ...
            Log.e("MicroMsg.SDK.NoopingTask", String.format("nooping fail, errCode = %s, uuidStatusCode = %d", new Object[]{c1108a.ap.toString(), Integer.valueOf(c1108a.ay)}));
            return c1108a;
        }
        Log.i("MicroMsg.SDK.NoopingTask", "IDiffDevOAuth.stopAuth / detach invoked");
        c1108a = new C1108a();
        c1108a.ap = OAuthErrCode.WechatAuth_Err_Auth_Stopped;
        return c1108a;
    }

    protected final /* synthetic */ void onPostExecute(Object obj) {
        C1108a c1108a = (C1108a) obj;
        this.an.onAuthFinish(c1108a.ap, c1108a.ax);
    }
}
