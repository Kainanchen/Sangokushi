...
class WebAuthHandler {
    ...
    private void startDialog(WeiboAuthListener weiboAuthListener, int i) {
        if (weiboAuthListener != null) {
            ...
            weiboParameters.put(WBConstants.SSO_USER_SCOPE, this.mAuthInfo.getScope());
            weiboParameters.put(WBConstants.AUTH_PARAMS_RESPONSE_TYPE, SelectCountryActivity.EXTRA_COUNTRY_CODE);
            ...
            if (!TextUtils.isEmpty(aid)) {
                weiboParameters.put(LogBuilder.KEY_AID, aid);
            }
