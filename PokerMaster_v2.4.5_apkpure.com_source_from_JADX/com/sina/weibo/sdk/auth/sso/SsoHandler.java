...
public class SsoHandler {
    ...
    /* renamed from: com.sina.weibo.sdk.auth.sso.SsoHandler.1 */
    class C09931 implements ServiceConnection {
        C09931() {
        }
    ...
    public void authorizeCallBack(int i, int i2, Intent intent) {
        LogUtil.m4621d(TAG, "requestCode: " + i + ", resultCode: " + i2 + ", data: " + intent);
        String stringExtra;
        Bundle extras;
        ...
        if (i == this.mSSOAuthRequestCode) {
            if (i2 == -1) {
                if (SecurityHelper.checkResponseAppLegal(this.mAuthActivity, this.mWeiboInfo, intent)) {
                    ...
                    if (stringExtra == null) {
                        ...
                        if (parseAccessToken == null || !parseAccessToken.isSessionValid()) {
                            LogUtil.m4621d(TAG, "Failed to receive access token by SSO");
                            this.mWebAuthHandler.anthorize(this.mAuthListener);
                            return;
                        }
                        LogUtil.m4621d(TAG, "Login Success! " + parseAccessToken.toString());
                        ...
                        LogUtil.m4621d(TAG, "Login canceled by user.");
                        ...
                        LogUtil.m4621d(TAG, "Login failed: " + stringExtra);
                ...
                if (intent != null) {
                    LogUtil.m4621d(TAG, "Login failed: " + intent.getStringExtra("error"));
    ...
    public static ComponentName isServiceExisted(Context context, String str) {
        for (RunningServiceInfo runningServiceInfo : ((ActivityManager) context.getSystemService(Constants.FLAG_ACTIVITY_NAME)).getRunningServices(ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED)) {
    ...
    private boolean startSingleSignOn(String str, String str2) {
        ...
        intent.putExtra(LogBuilder.KEY_AID, Utility.getAid(this.mAuthActivity, this.mAuthInfo.getAppKey()));
        ...
        if (!TextUtils.isEmpty(aid)) {
            intent.putExtra(LogBuilder.KEY_AID, aid);
        }
        try {
