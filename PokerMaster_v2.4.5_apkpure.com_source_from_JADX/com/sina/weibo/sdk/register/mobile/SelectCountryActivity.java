...
public class SelectCountryActivity extends Activity implements OnIndexChangeListener {
    ...
    /* renamed from: com.sina.weibo.sdk.register.mobile.SelectCountryActivity.1 */
    class C10121 implements ListenerOnTitleBtnClicked {
        C10121() {
        }
    ...
    /* renamed from: com.sina.weibo.sdk.register.mobile.SelectCountryActivity.2 */
    class C10132 implements OnItemClickListener {
        C10132() {
        }
    ...
    private class CountryAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                ((SelectCountryTitleView) view).update(ResourceManager.getString(SelectCountryActivity.this, SelectCountryActivity.INFO_EN, SelectCountryActivity.INFO_TW, SelectCountryActivity.INFO_TW));
                return view;
            }
        }
        ...
        private SelectCountryTitleView createTitleView(int i) {
            ...
            if (i == 0) {
                selectCountryTitleView.setTitle(ResourceManager.getString(SelectCountryActivity.this, SelectCountryActivity.INFO_EN, SelectCountryActivity.INFO_TW, SelectCountryActivity.INFO_TW));
            } else {
    ...
    public SelectCountryActivity() {
        this.countryStr = LetterIndexBar.SEARCH_ICON_LETTER;
    ...
    private void initView() {
        ...
        titleBar.setTitleBarClickListener(new C10121());
        ...
        this.mListView.setOnItemClickListener(new C10132());
