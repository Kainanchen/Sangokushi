...
public class GameManager {
    ...
    public static String addOrUpdateAchievementScore(Context context, String str, String str2, String str3, String str4, String str5) {
        WeiboParameters weiboParameters = new WeiboParameters(LetterIndexBar.SEARCH_ICON_LETTER);
        if (!TextUtils.isEmpty(str)) {
            weiboParameters.put(WBConstants.AUTH_ACCESS_TOKEN, str);
        }
        if (!TextUtils.isEmpty(str2)) {
            weiboParameters.put(WBConstants.GAME_PARAMS_SOURCE, str2);
        }
