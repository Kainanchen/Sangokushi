...
class WeiboGameClient extends WeiboWebViewClient {
    ...
    private void handleRedirectUrl(String str) {
        ...
        String string = parseUrl.getString("error") == null ? LetterIndexBar.SEARCH_ICON_LETTER : parseUrl.getString("error");
        String string2 = parseUrl.getString(SelectCountryActivity.EXTRA_COUNTRY_CODE);
        String string3 = parseUrl.getString(NotificationCompatApi24.CATEGORY_MESSAGE);
