...
public class AttentionComponentView extends FrameLayout {
    ...
    /* renamed from: com.sina.weibo.sdk.component.view.AttentionComponentView.1 */
    ...
    /* renamed from: com.sina.weibo.sdk.component.view.AttentionComponentView.2 */
    class C10002 implements RequestListener {
        ...
        public void onWeiboException(WeiboException weiboException) {
            LogUtil.m4621d(AttentionComponentView.TAG, "error : " + weiboException.getMessage());
            AttentionComponentView.this.mIsLoadingState = false;
        }

        public void onComplete(String str) {
            LogUtil.m4621d(AttentionComponentView.TAG, "json : " + str);
            try {
                AttentionComponentView.this.getHandler().post(new C09991(new JSONObject(str).optJSONObject("target")));
            } catch (JSONException e) {
            }
        }
    }

    /* renamed from: com.sina.weibo.sdk.component.view.AttentionComponentView.3 */
    class C10013 implements WidgetRequestCallback {
        C10013() {
        }
    ...
    private void init(Context context) {
        ...
        this.flButton.setOnClickListener(new C09981());
    ...
    private void loadAttentionState(RequestParam requestParam) {
        if (!this.mIsLoadingState) {
            ...
            weiboParameters.put(WBConstants.AUTH_ACCESS_TOKEN, requestParam.mAccessToken);
            ...
            NetUtils.internalHttpRequest(getContext(), FRIENDSHIPS_SHOW_URL, weiboParameters, "GET", new C10002());
        }
    }
    ...
    private void execAttented() {
        ...
        widgetRequestParam.setWidgetRequestCallback(new C10013());
