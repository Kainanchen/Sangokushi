...
public class WeiboSdkBrowser extends Activity implements BrowserRequestCallBack {
    ...
    class C09951 implements RequestListener {
        private final /* synthetic */ ShareRequestParam val$req;

        C09951(ShareRequestParam shareRequestParam) {
            this.val$req = shareRequestParam;
        }

        public void onWeiboException(WeiboException weiboException) {
            LogUtil.m4621d(WeiboSdkBrowser.TAG, "post onWeiboException " + weiboException.getMessage());
            this.val$req.sendSdkErrorResponse(WeiboSdkBrowser.this, weiboException.getMessage());
            WeiboSdkBrowser.this.finish();
        }

        public void onComplete(String str) {
            LogUtil.m4621d(WeiboSdkBrowser.TAG, "post onComplete : " + str);
    ...
    class C09973 implements OnClickListener {
        C09973() {
        }
    ...
    private boolean initDataFromIntent(Intent intent) {
        ...
        LogUtil.m4621d(TAG, "LOAD URL : " + this.mUrl);
        return true;
    }
    ...
    private void startShare() {
        LogUtil.m4621d(TAG, "Enter startShare()............");
        ShareRequestParam shareRequestParam = (ShareRequestParam) this.mRequestParam;
        if (shareRequestParam.hasImage()) {
            LogUtil.m4621d(TAG, "loadUrl hasImage............");
            new AsyncWeiboRunner(this).requestAsync(ShareRequestParam.UPLOAD_PIC_URL, shareRequestParam.buildUploadPicParam(new WeiboParameters(shareRequestParam.getAppKey())), "POST", new C09951(shareRequestParam));
            return;
        }
        openUrl(this.mUrl);
    }
    ...
    private void setTopNavTitle() {
        ...
        this.mLeftBtn.setOnClickListener(new C09962());
    }

    private void updateTitleName() {
        CharSequence charSequence = LetterIndexBar.SEARCH_ICON_LETTER;
    ...
    private void setContentView() {
        ...
        this.mLoadErrorRetryBtn.setOnClickListener(new C09973());
    ...
    public void onPageStartedCallBack(WebView webView, String str, Bitmap bitmap) {
        LogUtil.m4621d(TAG, "onPageStarted URL: " + str);
        this.mUrl = str;
        if (!isWeiboCustomScheme(str)) {
            this.mHtmlTitle = LetterIndexBar.SEARCH_ICON_LETTER;
        }
    }

    public boolean shouldOverrideUrlLoadingCallBack(WebView webView, String str) {
        LogUtil.m4623i(TAG, "shouldOverrideUrlLoading URL: " + str);
        return false;
    }

    public void onPageFinishedCallBack(WebView webView, String str) {
        LogUtil.m4621d(TAG, "onPageFinished URL: " + str);
        if (this.isErrorPage) {
            promptError();
            return;
        }
    ...
    public void onReceivedErrorCallBack(WebView webView, int i, String str, String str2) {
        LogUtil.m4621d(TAG, "onReceivedError: errorCode = " + i + ", description = " + str + ", failingUrl = " + str2);
    ...
    public void onReceivedSslErrorCallBack(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
        LogUtil.m4621d(TAG, "onReceivedSslErrorCallBack.........");
    }
