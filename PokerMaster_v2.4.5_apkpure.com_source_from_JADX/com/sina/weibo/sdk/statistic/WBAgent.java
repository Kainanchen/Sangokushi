...
public class WBAgent {
    ...
    public static void onResume(Context context) {
        if (context == null) {
            LogUtil.m4622e(TAG, "unexpected null context in onResume");
        } else {
    ...
    public static void onEvent(Object obj, String str, Map<String, String> map) {
        if (obj == null) {
            LogUtil.m4622e(TAG, "unexpected null page or activity in onEvent");
        } else if (str == null) {
            LogUtil.m4622e(TAG, "unexpected null eventId in onEvent");
        } else {
            String name;
    ...
    public static void uploadAppLogs(Context context) {
        if (context == null) {
            LogUtil.m4622e(TAG, "unexpected null context in uploadAppLogs");
        } else {
    ...
    public static void onStop(Context context) {
        if (context == null) {
            LogUtil.m4622e(TAG, "unexpected null context in onStop");
        } else {
