...
class LogBuilder {
    ...
    public static String getAppKey(Context context) {
        try {
            ...
            if (applicationInfo != null) {
                ...
                if (obj != null) {
                    LogUtil.m4623i(WBAgent.TAG, "APPKEY: " + String.valueOf(obj));
                    return String.valueOf(obj);
                }
                LogUtil.m4622e(WBAgent.TAG, "Could not read WEIBO_APPKEY meta-data from AndroidManifest.xml.");
            }
        } catch (Exception e) {
            LogUtil.m4622e(WBAgent.TAG, "Could not read WEIBO_APPKEY meta-data from AndroidManifest.xml." + e);
        }
        return null;
    }
    ...
    public static String getChannel(Context context) {
        try {
            ...
            if (applicationInfo != null) {
                ...
                if (string != null) {
                    LogUtil.m4623i(WBAgent.TAG, "CHANNEL: " + string.trim());
                    return string.trim();
                }
                LogUtil.m4622e(WBAgent.TAG, "Could not read WEIBO_CHANNEL meta-data from AndroidManifest.xml.");
            }
        } catch (Exception e) {
            LogUtil.m4622e(WBAgent.TAG, "Could not read WEIBO_CHANNEL meta-data from AndroidManifest.xml." + e);
        }
        return null;
    }
    ...
    public static String getVersion(Context context) {
        try {
            ...
            LogUtil.m4623i(WBAgent.TAG, "versionName: " + packageInfo.versionName);
            return packageInfo.versionName;
        } catch (NameNotFoundException e) {
            LogUtil.m4622e(WBAgent.TAG, "Could not read versionName from AndroidManifest.xml." + e);
            return null;
        }
    }
    ...
    L_0x002a:
        ...
        r0 = r3.append(r0);
        r0 = r0.toString();
        com.sina.weibo.sdk.utils.LogUtil.m4622e(r2, r0);
        goto L_0x0016;
    L_0x0040:
        r0 = "type";
        r2 = 1;
    ...
    private static JSONObject addEventData(JSONObject jSONObject, EventLog eventLog) {
        try {
            ...
            LogUtil.m4622e(WBAgent.TAG, "add event log error." + e);
        }
        return jSONObject;
    }
    ...
    private static String buildUploadLogs(String str) {
        ...
        if (stringBuilder.charAt(stringBuilder.length() - 1) == ',') {
            stringBuilder.replace(stringBuilder.length() - 1, stringBuilder.length(), LetterIndexBar.SEARCH_ICON_LETTER);
        }
        stringBuilder.append("]}");
        return stringBuilder.toString();
    }
