...
public class WbAppActivator {
    ...
    class C09941 implements Runnable {
        ...
        C09941(SharedPreferences sharedPreferences) {
        ...
        public void run() {
            ...
            Throwable th;
            LogUtil.m4624v(WbAppActivator.TAG, "mLock.isLocked()--->" + WbAppActivator.this.mLock.isLocked());
                ...
                try {
                    ...
                    if (access$4 != null) {
                        ...
                        try {
                            ...
                            try {
                                LogUtil.m4622e(WbAppActivator.TAG, weiboException.getMessage());
    ...
    public void activateApp() {
        ...
        if (System.currentTimeMillis() - FrequencyHelper.getLastTime(this.mContext, weiboSdkSp) < FrequencyHelper.getFrequency(this.mContext, weiboSdkSp)) {
            LogUtil.m4624v(TAG, String.format("it's only %d ms from last time get cmd", new Object[]{Long.valueOf(r4)}));
            return;
        }
        new Thread(new C09941(weiboSdkSp)).start();
    }
