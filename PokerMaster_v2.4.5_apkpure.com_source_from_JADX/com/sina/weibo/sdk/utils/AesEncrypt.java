...
public class AesEncrypt {
    public static String Encrypt(String str) {
        try {
            ...
            LogUtil.m4622e("Encrypt", e.getMessage());
            return null;
        }
    }
    ...
    public static String Decrypt(String str) {
        try {
            ...
            try {
                ...
                LogUtil.m4622e("Decrypt", e.getMessage());
                return null;
            }
        } catch (Exception e2) {
            LogUtil.m4622e("Decrypt", e2.getMessage());
            return null;
        }
    }
    ...
    protected static Key generateKey(String str) {
        try {
            ...
            if (substring == null) {
                LogUtil.m4624v("Decrypt", "Key\u4e3a\u7a7anull");
                return null;
            } else if (substring.length() == 16) {
                return new SecretKeySpec(substring.getBytes("utf-8"), "AES");
            } else {
                LogUtil.m4624v("Decrypt", "Key\u957f\u5ea6\u4e0d\u662f16\u4f4d");
                return null;
            }
        } catch (Exception e) {
            LogUtil.m4622e("generateKey", e.getMessage());
            return null;
        }
    }
