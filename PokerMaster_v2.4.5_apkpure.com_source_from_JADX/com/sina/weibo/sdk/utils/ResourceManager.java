...
public class ResourceManager {
    ...
    private static String getAppropriatePathOfDrawable(Context context, String str) {
        if (TextUtils.isEmpty(str)) {
            LogUtil.m4622e(TAG, "id is NOT correct!");
            return null;
        }
        String currentDpiFolder = getCurrentDpiFolder(context);
        LogUtil.m4621d(TAG, "find Appropriate path...");
        int i = 0;
        int i2 = -1;
        int i3 = -1;
        ...
        if (i3 <= 0 || i <= 0) {
            if (i3 <= 0 || i >= 0) {
                if (i3 >= 0 || i <= 0) {
                    LogUtil.m4622e(TAG, "Not find the appropriate path for drawable");
                    i3 = -1;
                } else {
                    i3 = i;
                }
    ...
    private static boolean isFileExisted(Context context, String str) {
        ...
        try {
            ...
            LogUtil.m4621d(TAG, "file [" + str + "] existed");
            if (inputStream != null) {
                try {
                    inputStream.close();
                } catch (IOException e) {
            ...
            LogUtil.m4621d(TAG, "file [" + str + "] NOT existed");
            if (inputStream == null) {
                return false;
            }
            try {
