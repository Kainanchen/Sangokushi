...
public final class WeiboPageUtils {
    ...
    public static void postNewWeibo(Context context, String str, String str2, String str3, Position position, String str4, String str5) {
        if (context == null) {
        ...
        try {
            hashMap.put(MessageKey.MSG_CONTENT, URLEncoder.encode(str, GameManager.DEFAULT_CHARSET).replaceAll("\\+", "%20"));
    ...
    public static void viewNearbyPeople(Context context, Position position, String str) {
        if (context == null) {
            throw new WeiboIllegalParameterException(ExceptionMsg.CONTEXT_ERROR);
        }
    ...
    public static void viewNearbyWeibo(Context context, Position position, String str) {
        if (context == null) {
            throw new WeiboIllegalParameterException(ExceptionMsg.CONTEXT_ERROR);
        }
    ...
    public static void displayInWeiboMap(Context context, Position position, String str) {
        if (context == null) {
            throw new WeiboIllegalParameterException(ExceptionMsg.CONTEXT_ERROR);
        }
