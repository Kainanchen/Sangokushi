...
public class HttpManager {
    ...
    /* renamed from: com.sina.weibo.sdk.net.HttpManager.1 */
    class C10061 implements RedirectHandler {
        C10061() {
        }

        public boolean isRedirectRequested(HttpResponse httpResponse, HttpContext httpContext) {
            LogUtil.m4621d(HttpManager.TAG, "openUrl4RdirectURL isRedirectRequested method");
            return false;
        }

        public URI getLocationURI(HttpResponse httpResponse, HttpContext httpContext) {
            LogUtil.m4621d(HttpManager.TAG, "openUrl4RdirectURL getLocationURI method");
            return null;
        }
    }

    /* renamed from: com.sina.weibo.sdk.net.HttpManager.2 */
    class C10072 extends CustomRedirectHandler {
        C10072() {
        }
    ...
    public static String openUrl(Context context, String str, String str2, WeiboParameters weiboParameters) {
        ...
        LogUtil.m4621d(TAG, "Response : " + readRsponse);
        return readRsponse;
    }
        ...
        try {
            ...
            try {
                ...
                if (str2.equals(HTTP_METHOD_GET)) {
                    ...
                    LogUtil.m4621d(TAG, "requestHttpExecute GET Url : " + stringBuilder);
                } else if (str2.equals(HTTP_METHOD_POST)) {
                    LogUtil.m4621d(TAG, "requestHttpExecute POST Url : " + str);
                    ...
                    try {
                        ...
                        if (weiboParameters.hasBinaryData()) {
                            ...
                            LogUtil.m4621d(TAG, "requestHttpExecute POST postParam : " + encodeUrl);
    ...
    private static void setHttpCommonParam(Context context, WeiboParameters weiboParameters) {
        ...
        if (!TextUtils.isEmpty(weiboParameters.getAppKey())) {
            ...
            if (!TextUtils.isEmpty(str)) {
                weiboParameters.put(LogBuilder.KEY_AID, str);
            }
        }
        String str2 = str;
        ...
        Object obj = weiboParameters.get(WBConstants.AUTH_ACCESS_TOKEN);
    ...
    public static String openUrl4RdirectURL(Context context, String str, String str2, WeiboParameters weiboParameters) {
        ...
        try {
            ...
            try {
                HttpUriRequest httpGet;
                defaultHttpClient.setRedirectHandler(new C10061());
                setHttpCommonParam(context, weiboParameters);
                defaultHttpClient.getParams().setParameter("http.route.default-proxy", NetStateManager.getAPN());
                if (str2.equals(HTTP_METHOD_GET)) {
                    String stringBuilder = new StringBuilder(String.valueOf(str)).append("?").append(weiboParameters.encodeUrl()).toString();
                    LogUtil.m4621d(TAG, "openUrl4RdirectURL GET url : " + stringBuilder);
                    httpGet = new HttpGet(stringBuilder);
                } else if (str2.equals(HTTP_METHOD_POST)) {
                    httpGet = new HttpPost(str);
                    LogUtil.m4621d(TAG, "openUrl4RdirectURL POST url : " + str);
                }
                ...
                if (statusCode == 301 || statusCode == 302) {
                    ...
                    LogUtil.m4621d(TAG, "RedirectURL = " + value);
    ...
    public static String openRedirectUrl4LocationUri(Context context, String str, String str2, WeiboParameters weiboParameters) {
        ...
        HttpClient httpClient = null;
        try {
            Object c10072 = new C10072();
            DefaultHttpClient defaultHttpClient = (DefaultHttpClient) getNewHttpClient();
            try {
                HttpUriRequest httpGet;
                defaultHttpClient.setRedirectHandler(c10072);
                setHttpCommonParam(context, weiboParameters);
                defaultHttpClient.getParams().setParameter("http.route.default-proxy", NetStateManager.getAPN());
                if (str2.equals(HTTP_METHOD_GET)) {
                ...
                String redirectUrl = c10072.getRedirectUrl();
                shutdownHttpClient(defaultHttpClient);
                return redirectUrl;
            } catch (Throwable e) {
                th = e;
        ...
        synchronized (HttpManager.class) {
            ...
            if (file2.exists()) {
                ...
                try {
                    ...
                    if (firstHeader2 == null || firstHeader2.getValue().toLowerCase().indexOf("gzip") < 0) {
                    ...
                    if (parseLong == 0 || file3.length() < parseLong) {
                        ...
                        path = LetterIndexBar.SEARCH_ICON_LETTER;
                    } else {
        ...
        if (httpResponse != null) {
            ...
            try {
                ...
                try {
                    ...
                    LogUtil.m4621d(TAG, "readRsponse result : " + str);
                    if (content != null) {
                        try {
                            content.close();
                        } catch (IOException e2) {
    ...
    private static SSLSocketFactory getSSLSocketFactory() {
        if (sSSLSocketFactory == null) {
            try {
                ...
                LogUtil.m4621d(TAG, "getSSLSocketFactory noraml !!!!!");
            } catch (Exception e) {
                e.printStackTrace();
                sSSLSocketFactory = SSLSocketFactory.getSocketFactory();
                LogUtil.m4621d(TAG, "getSSLSocketFactory error default !!!!!");
            }
        }
    ...
    private static String getOauthSign(Context context, String str, String str2, String str3, String str4) {
        StringBuilder stringBuilder = new StringBuilder(LetterIndexBar.SEARCH_ICON_LETTER);
        if (!TextUtils.isEmpty(str)) {
