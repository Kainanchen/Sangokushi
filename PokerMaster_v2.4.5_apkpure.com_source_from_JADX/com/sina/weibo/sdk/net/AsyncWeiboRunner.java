...
public class AsyncWeiboRunner {
    ...
    class C10051 extends Thread {
        ...
        C10051(String str, String str2, WeiboParameters weiboParameters, RequestListener requestListener) {
            this.val$url = str;
    ...
    public void requestByThread(String str, WeiboParameters weiboParameters, String str2, RequestListener requestListener) {
        new C10051(str, str2, weiboParameters, requestListener).start();
    }
