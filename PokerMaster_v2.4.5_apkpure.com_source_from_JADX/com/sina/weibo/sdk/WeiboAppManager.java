    ...
    public WeiboInfo parseWeiboInfoByAsset(String str) {
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    int read = open.read(bArr, 0, CodedOutputStream.DEFAULT_BUFFER_SIZE);
                    if (read == -1) {
                        break;
                    }
                ...
                if (!TextUtils.isEmpty(stringBuilder.toString()) && ApiUtils.validateWeiboSign(this.mContext, str)) {
                    ...
                    if (open != null) {
                        try {
                            ...
                            LogUtil.m4622e(TAG, e5.getMessage());
                        }
                    }
                    return weiboInfo;
                } else if (open == null) {
                    ...
                    try {
                        ...
                        LogUtil.m4622e(TAG, e6.getMessage());
                        return null;
                    }
                }
            ...
            try {
                ...
                try {
                    ...
                    LogUtil.m4622e(TAG, e62.getMessage());
                    return null;
                }
            } catch (Throwable th2) {
                th = th2;
                if (open != null) {
                    try {
                        ...
                        LogUtil.m4622e(TAG, e622.getMessage());
                    }
                }
                throw th;
            }
            ...
            try {
                ...
                LogUtil.m4622e(TAG, e6222.getMessage());
                return null;
            }
        } catch (JSONException e13) {
            e3 = e13;
            open = null;
            LogUtil.m4622e(TAG, e3.getMessage());
            if (open == null) {
                return null;
            }
            try {
                ...
                LogUtil.m4622e(TAG, e62222.getMessage());
                return null;
            }
        } catch (Exception e14) {
            e4 = e14;
            open = null;
            LogUtil.m4622e(TAG, e4.getMessage());
            if (open == null) {
                return null;
            }
            try {
                ...
                LogUtil.m4622e(TAG, e622222.getMessage());
                return null;
            }
        } catch (Throwable th3) {
            open = null;
