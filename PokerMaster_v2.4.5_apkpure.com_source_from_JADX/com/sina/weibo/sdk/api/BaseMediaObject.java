...
public abstract class BaseMediaObject implements Parcelable {
    ...
    public final void setThumbImage(Bitmap bitmap) {
        ...
        try {
            ...
            try {
                ...
                try {
                    e.printStackTrace();
                    LogUtil.m4622e("Weibo.BaseMediaObject", "put thumb failed");
    ...
    protected boolean checkArgs() {
        if (this.actionUrl == null || this.actionUrl.length() > AccessibilityNodeInfoCompat.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY) {
            LogUtil.m4622e("Weibo.BaseMediaObject", "checkArgs fail, actionUrl is invalid");
            return false;
        } else if (this.identify == null || this.identify.length() > AccessibilityNodeInfoCompat.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY) {
            LogUtil.m4622e("Weibo.BaseMediaObject", "checkArgs fail, identify is invalid");
            return false;
        } else if (this.thumbData == null || this.thumbData.length > WXMediaMessage.THUMB_LENGTH_LIMIT) {
            LogUtil.m4622e("Weibo.BaseMediaObject", "checkArgs fail, thumbData is invalid,size is " + (this.thumbData != null ? this.thumbData.length : -1) + "! more then 32768.");
            return false;
        } else if (this.title == null || this.title.length() > AccessibilityNodeInfoCompat.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY) {
            LogUtil.m4622e("Weibo.BaseMediaObject", "checkArgs fail, title is invalid");
            return false;
        } else if (this.description != null && this.description.length() <= AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT) {
            return true;
        } else {
            LogUtil.m4622e("Weibo.BaseMediaObject", "checkArgs fail, description is invalid");
            return false;
        }
    }
}
