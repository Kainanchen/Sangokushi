...
class WeiboShareAPIImpl implements IWeiboShareAPI {
    ...
    public WeiboShareAPIImpl(Context context, String str, boolean z) {
        ...
        if (this.mWeiboInfo != null) {
            LogUtil.m4621d(TAG, this.mWeiboInfo.toString());
        } else {
            LogUtil.m4621d(TAG, "WeiboInfo is null");
        }
    ...
    public boolean handleWeiboResponse(Intent intent, Response response) {
        ...
        if (TextUtils.isEmpty(stringExtra)) {
            LogUtil.m4622e(TAG, "handleWeiboResponse faild appPackage is null");
            return false;
        } else if (response instanceof Activity) {
            Activity activity = (Activity) response;
            LogUtil.m4621d(TAG, "handleWeiboResponse getCallingPackage : " + activity.getCallingPackage());
            if (TextUtils.isEmpty(stringExtra2)) {
                LogUtil.m4622e(TAG, "handleWeiboResponse faild intent _weibo_transaction is null");
                return false;
                ...
                LogUtil.m4622e(TAG, "handleWeiboResponse faild appPackage validateSign faild");
                return false;
            }
        } else {
            LogUtil.m4622e(TAG, "handleWeiboResponse faild handler is not Activity");
            return false;
        }
    }
    ...
    public boolean handleWeiboRequest(Intent intent, Request request) {
        ...
        CharSequence stringExtra2 = intent.getStringExtra(WBConstants.TRAN);
        if (TextUtils.isEmpty(stringExtra)) {
            LogUtil.m4622e(TAG, "handleWeiboRequest faild appPackage validateSign faild");
            request.onRequest(null);
            return false;
        } else if (TextUtils.isEmpty(stringExtra2)) {
            LogUtil.m4622e(TAG, "handleWeiboRequest faild intent _weibo_transaction is null");
            request.onRequest(null);
            return false;
    ...
    public boolean launchWeibo(Activity activity) {
        if (isWeiboAppInstalled()) {
            try {
                ...
                LogUtil.m4622e(TAG, e.getMessage());
                return false;
            }
        }
        LogUtil.m4622e(TAG, "launchWeibo faild WeiboInfo is null");
        return false;
    }

    public boolean sendRequest(Activity activity, BaseRequest baseRequest) {
        if (baseRequest == null) {
            LogUtil.m4622e(TAG, "sendRequest faild request is null");
            return false;
        }
        try {
            ...
            LogUtil.m4622e(TAG, "sendRequest faild request check faild");
            return false;
        } catch (Exception e) {
            LogUtil.m4622e(TAG, e.getMessage());
            return false;
    ...
    public boolean sendResponse(BaseResponse baseResponse) {
        if (baseResponse == null) {
            LogUtil.m4622e(TAG, "sendResponse failed response null");
            return false;
            ...
            LogUtil.m4622e(TAG, "sendResponse check fail");
            return false;
        }
    }
    ...
    public boolean launchWeiboPayLogin(Activity activity, String str) {
        ...
        if (activity == null) {
            LogUtil.m4622e(TAG, "launchWeiboActivity fail, invalid arguments");
            return false;
        }
        Bundle bundle = new Bundle();
        bundle.putString("rawdata", str);
        ...
        try {
            LogUtil.m4621d(TAG, "launchWeiboActivity intent=" + intent + ", extra=" + intent.getExtras());
    ...
    private void sendBroadcast(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        LogUtil.m4621d(TAG, "intent=" + intent + ", extra=" + intent.getExtras());
