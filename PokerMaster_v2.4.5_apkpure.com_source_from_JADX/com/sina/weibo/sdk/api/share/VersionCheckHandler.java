...
public class VersionCheckHandler implements IVersionCheckHandler {
    ...
    public boolean checkRequest(Context context, WeiboInfo weiboInfo, WeiboMessage weiboMessage) {
        ...
        LogUtil.m4621d(TAG, "WeiboMessage WeiboInfo package : " + weiboInfo.getPackageName());
        LogUtil.m4621d(TAG, "WeiboMessage WeiboInfo supportApi : " + weiboInfo.getSupportApi());
    ...
    public boolean checkRequest(Context context, WeiboInfo weiboInfo, WeiboMultiMessage weiboMultiMessage) {
        ...
        LogUtil.m4621d(TAG, "WeiboMultiMessage WeiboInfo package : " + weiboInfo.getPackageName());
        LogUtil.m4621d(TAG, "WeiboMultiMessage WeiboInfo supportApi : " + weiboInfo.getSupportApi());
