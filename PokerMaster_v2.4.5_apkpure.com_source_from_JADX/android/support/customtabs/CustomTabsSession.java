...
public final class CustomTabsSession {
    ...
    public final boolean setActionButton(@NonNull Bitmap bitmap, @NonNull String str) {
    ...
    public final boolean setSecondaryToolbarViews(@Nullable RemoteViews remoteViews, @Nullable int[] iArr, @Nullable PendingIntent pendingIntent) {
        Bundle bundle = new Bundle();
    ...
    @Deprecated
    public final boolean setToolbarItem(int i, @NonNull Bitmap bitmap, @NonNull String str) {
        Bundle bundle = new Bundle();
