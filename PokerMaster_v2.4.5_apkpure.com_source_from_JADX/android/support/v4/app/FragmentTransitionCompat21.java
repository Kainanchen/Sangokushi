...
class FragmentTransitionCompat21 {
    ...
    static class C00231 extends EpicenterCallback {
    ...
    static class C00242 implements TransitionListener {
        final /* synthetic */ ArrayList val$exitingViews;
        final /* synthetic */ View val$fragmentView;

        C00242(View view, ArrayList arrayList) {
    ...
    static class C00253 implements OnPreDrawListener {
        ...
        C00253(View view, int i, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
    ...
    static class C00264 implements OnPreDrawListener {
        final /* synthetic */ Map val$nameOverrides;
        final /* synthetic */ View val$sceneRoot;
        final /* synthetic */ ArrayList val$sharedElementsIn;

        C00264(View view, ArrayList arrayList, Map map) {
            this.val$sceneRoot = view;
            this.val$sharedElementsIn = arrayList;
    ...
    static class C00275 implements TransitionListener {
        ...
        C00275(Object obj, ArrayList arrayList, Object obj2, ArrayList arrayList2, Object obj3, ArrayList arrayList3) {
    ...
    static class C00286 extends EpicenterCallback {
        final /* synthetic */ Rect val$epicenter;
    ...
    static class C00297 implements OnPreDrawListener {
        final /* synthetic */ Map val$nameOverrides;
        final /* synthetic */ ViewGroup val$sceneRoot;
        final /* synthetic */ ArrayList val$sharedElementsIn;

        C00297(ViewGroup viewGroup, ArrayList arrayList, Map map) {
    ...
    public static void setEpicenter(Object obj, View view) {
        if (view != null) {
            ...
            transition.setEpicenterCallback(new C00231(rect));
        }
    }
    ...
    public static void scheduleHideFragmentView(Object obj, View view, ArrayList<View> arrayList) {
        ((Transition) obj).addListener(new C00242(view, arrayList));
    }
    ...
    public static void setNameOverridesOptimized(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        view.getViewTreeObserver().addOnPreDrawListener(new C00253(view, size, arrayList2, arrayList3, arrayList, arrayList4));
    }
    ...
    public static void setNameOverridesUnoptimized(View view, ArrayList<View> arrayList, Map<String, String> map) {
        view.getViewTreeObserver().addOnPreDrawListener(new C00264(view, arrayList, map));
    }
    ...
    public static void scheduleRemoveTargets(Object obj, Object obj2, ArrayList<View> arrayList, Object obj3, ArrayList<View> arrayList2, Object obj4, ArrayList<View> arrayList3) {
        ((Transition) obj).addListener(new C00275(obj2, arrayList, obj3, arrayList2, obj4, arrayList3));
    }
    ...
    public static void setEpicenter(Object obj, Rect rect) {
        if (obj != null) {
            ((Transition) obj).setEpicenterCallback(new C00286(rect));
        }
    }

    public static void scheduleNameReset(ViewGroup viewGroup, ArrayList<View> arrayList, Map<String, String> map) {
        viewGroup.getViewTreeObserver().addOnPreDrawListener(new C00297(viewGroup, arrayList, map));
    }
}
