...
class ViewPropertyAnimatorCompatKK {
    ...
    static class C01241 implements AnimatorUpdateListener {
        final /* synthetic */ ViewPropertyAnimatorUpdateListener val$listener;
        final /* synthetic */ View val$view;

        C01241(ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener, View view) {
    ...
    public static void setUpdateListener(View view, ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener) {
        ...
        if (viewPropertyAnimatorUpdateListener != null) {
            animatorUpdateListener = new C01241(viewPropertyAnimatorUpdateListener, view);
        }
