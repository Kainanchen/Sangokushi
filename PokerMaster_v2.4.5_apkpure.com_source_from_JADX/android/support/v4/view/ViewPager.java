...
public class ViewPager extends ViewGroup {
    ...
    static class C01171 implements Comparator<ItemInfo> {
        C01171() {
        }
    ...
    static class C01182 implements Interpolator {
        C01182() {
        }
    ...
    class C01204 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C01211 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01211() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01211());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01171();
        sInterpolator = new C01182();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01193();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01204());
    }
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        if (itemInfo2 != null) {
            ...
            if (clientWidth < itemInfo.position) {
                ...
                i5 = clientWidth + SCROLL_STATE_DRAGGING;
                while (i5 <= itemInfo.position && i4 < this.mItems.size()) {
                    itemInfo3 = (ItemInfo) this.mItems.get(i4);
                    while (i5 > itemInfo3.position && i4 < this.mItems.size() + INVALID_POINTER) {
                    ...
                    clientWidth = i2 + SCROLL_STATE_DRAGGING;
                    f3 = f2;
                    i5 = clientWidth;
                }
            } else if (clientWidth > itemInfo.position) {
                i4 = this.mItems.size() + INVALID_POINTER;
                f3 = itemInfo2.offset;
                i5 = clientWidth + INVALID_POINTER;
                while (i5 >= itemInfo.position && i4 >= 0) {
                    ...
                    f2 -= itemInfo3.widthFactor + f;
                    itemInfo3.offset = f2;
                    clientWidth = i2 + INVALID_POINTER;
                    f3 = f2;
                    i5 = clientWidth;
                }
            }
        ...
        for (int i4 = SCROLL_STATE_IDLE; i4 < childCount; i4 += SCROLL_STATE_DRAGGING) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    int i7 = layoutParams.gravity & R.AppCompatTheme_spinnerStyle;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i8 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                layoutParams = (LayoutParams) childAt.getLayoutParams();
                if (layoutParams.isDecor) {
                    int i9 = layoutParams.gravity & R.AppCompatTheme_spinnerStyle;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction() & MotionEventCompat.ACTION_MASK) {
            ...
            case SCROLL_STATE_SETTLING /*2*/:
                ...
                if (this.mIsBeingDragged) {
                    z = performDrag(motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId))) | SCROLL_STATE_IDLE;
                    break;
                }
                break;
            case SQLiteDatabase.CONFLICT_FAIL /*3*/:
