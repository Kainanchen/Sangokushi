...
public class ViewCompat {
    ...
    static class LollipopViewCompatImpl extends KitKatViewCompatImpl {
        ...
        class C01151 implements OnApplyWindowInsetsListenerBridge {
            final /* synthetic */ OnApplyWindowInsetsListener val$listener;

            C01151(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        ...
        public void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
            if (onApplyWindowInsetsListener == null) {
                ...
                ViewCompatLollipop.setOnApplyWindowInsetsListener(view, new C01151(onApplyWindowInsetsListener));
            }
        }
