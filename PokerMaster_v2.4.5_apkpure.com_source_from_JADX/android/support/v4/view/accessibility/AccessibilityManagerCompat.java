...
public final class AccessibilityManagerCompat {
    ...
    static class AccessibilityManagerIcsImpl extends AccessibilityManagerStubImpl {
        ...
        class C01251 implements AccessibilityStateChangeListenerBridge {
            final /* synthetic */ AccessibilityStateChangeListener val$listener;

            C01251(AccessibilityStateChangeListener accessibilityStateChangeListener) {
        ...
        public AccessibilityStateChangeListenerWrapper newAccessibilityStateChangeListener(AccessibilityStateChangeListener accessibilityStateChangeListener) {
            return new AccessibilityStateChangeListenerWrapper(accessibilityStateChangeListener, new C01251(accessibilityStateChangeListener));
        }
    ...
    static class AccessibilityManagerKitKatImpl extends AccessibilityManagerIcsImpl {
        ...
        class C01261 implements TouchExplorationStateChangeListenerBridge {
            final /* synthetic */ TouchExplorationStateChangeListener val$listener;

            C01261(TouchExplorationStateChangeListener touchExplorationStateChangeListener) {
        ...
        public TouchExplorationStateChangeListenerWrapper newTouchExplorationStateChangeListener(TouchExplorationStateChangeListener touchExplorationStateChangeListener) {
            return new TouchExplorationStateChangeListenerWrapper(touchExplorationStateChangeListener, new C01261(touchExplorationStateChangeListener));
        }
