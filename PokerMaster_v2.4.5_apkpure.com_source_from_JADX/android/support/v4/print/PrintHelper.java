...
public final class PrintHelper {
    ...
    private static class PrintHelperImpl<RealHelper extends PrintHelperKitkat> implements PrintHelperVersionImpl {
        ...
        class C00941 implements android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback {
            final /* synthetic */ OnPrintFinishCallback val$callback;

            C00941(OnPrintFinishCallback onPrintFinishCallback) {
        ...
        class C00952 implements android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback {
            final /* synthetic */ OnPrintFinishCallback val$callback;

            C00952(OnPrintFinishCallback onPrintFinishCallback) {
                this.val$callback = onPrintFinishCallback;
            }
        ...
        public void printBitmap(String str, Bitmap bitmap, OnPrintFinishCallback onPrintFinishCallback) {
            ...
            if (onPrintFinishCallback != null) {
                onPrintFinishCallback2 = new C00941(onPrintFinishCallback);
            }
        ...
        public void printBitmap(String str, Uri uri, OnPrintFinishCallback onPrintFinishCallback) {
            android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback onPrintFinishCallback2 = null;
            if (onPrintFinishCallback != null) {
                onPrintFinishCallback2 = new C00952(onPrintFinishCallback);
            }
