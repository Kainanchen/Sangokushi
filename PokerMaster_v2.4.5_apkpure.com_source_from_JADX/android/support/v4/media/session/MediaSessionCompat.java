...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class C00831 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C00831() {
            }
        ...
        class C00842 implements Callback {
            C00842() {
            }
        ...
        class MediaSessionStub extends Stub {
            ...
            public void sendCommand(String str, Bundle bundle, ResultReceiverWrapper resultReceiverWrapper) {
                MediaSessionImplBase.this.postToHandler(MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS, new Command(str, bundle, resultReceiverWrapper.mResultReceiver));
            }
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent) {
            ...
            this.mVolumeCallback = new C00831();
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            Object c00842 = new C00842();
            if (VERSION.SDK_INT >= 18) {
                MediaSessionCompatApi18.setOnPlaybackPositionUpdateListener(this.mRccObj, MediaSessionCompatApi18.createPlaybackPositionUpdateListener(c00842));
            }
            if (VERSION.SDK_INT >= 19) {
                MediaSessionCompatApi19.setOnMetadataUpdateListener(this.mRccObj, MediaSessionCompatApi19.createMetadataUpdateListener(c00842));
            }
        }
