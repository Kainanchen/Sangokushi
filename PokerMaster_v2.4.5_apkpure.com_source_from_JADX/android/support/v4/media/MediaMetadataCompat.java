...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public final MediaDescriptionCompat getDescription() {
        ...
        if (TextUtils.isEmpty(text)) {
            ...
            i2 = METADATA_TYPE_LONG;
            while (i2 < METADATA_TYPE_RATING && i < PREFERRED_DESCRIPTION_ORDER.length) {
        ...
        bitmap = null;
        for (i2 = METADATA_TYPE_LONG; i2 < PREFERRED_URI_ORDER.length; i2 += METADATA_TYPE_TEXT) {
            string = getString(PREFERRED_URI_ORDER[i2]);
