...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplApi21 implements ConnectionCallbackInternal, MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        class C00421 implements Runnable {
            ...
            C00421(ItemCallback itemCallback, String str) {
        ...
        class C00432 implements Runnable {
            ...
            C00432(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        class C00443 implements Runnable {
            ...
            C00443(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        public MediaBrowserImplApi21(Context context, ComponentName componentName, ConnectionCallback connectionCallback, Bundle bundle) {
            Bundle bundle2;
            MediaBrowserImplApi21 mediaBrowserImplApi21;
            ...
            mediaBrowserImplApi21.mRootHints = bundle2;
        ...
        public void getItem(@NonNull String str, @NonNull ItemCallback itemCallback) {
            if (TextUtils.isEmpty(str)) {
                ...
                this.mHandler.post(new C00421(itemCallback, str));
            } else if (this.mServiceBinderWrapper == null) {
                this.mHandler.post(new C00432(itemCallback, str));
            } else {
                try {
                    this.mServiceBinderWrapper.getMediaItem(str, new ItemReceiver(str, itemCallback, this.mHandler), this.mCallbacksMessenger);
                } catch (RemoteException e) {
                    Log.i(MediaBrowserCompat.TAG, "Remote error getting media item: " + str);
                    this.mHandler.post(new C00443(itemCallback, str));
                }
            }
        }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        class C00451 implements Runnable {
            ...
            C00451(ServiceConnection serviceConnection) {
        ...
        class C00462 implements Runnable {
            ...
            C00462(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        class C00473 implements Runnable {
            ...
            C00473(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        private class MediaServiceConnection implements ServiceConnection {
            ...
            class C00481 implements Runnable {
                ...
                C00481(ComponentName componentName, IBinder iBinder) {
                ...
                public void run() {
                    if (MediaBrowserCompat.DEBUG) {
                        new StringBuilder("MediaServiceConnection.onServiceConnected name=").append(this.val$name).append(" binder=").append(this.val$binder);
            ...
            class C00492 implements Runnable {
                ...
                C00492(ComponentName componentName) {
                    this.val$name = componentName;
                }

                public void run() {
                    if (MediaBrowserCompat.DEBUG) {
                        new StringBuilder("MediaServiceConnection.onServiceDisconnected name=").append(this.val$name).append(" this=").append(this).append(" mServiceConnection=").append(MediaBrowserImplBase.this.mServiceConnection);
                        MediaBrowserImplBase.this.dump();
                    }
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                postOrRun(new C00481(componentName, iBinder));
            }

            public void onServiceDisconnected(ComponentName componentName) {
                postOrRun(new C00492(componentName));
            }
        ...
        public void connect() {
            if (this.mState != 0) {
                ...
                if (!z) {
                    this.mHandler.post(new C00451(mediaServiceConnection));
                }
                if (MediaBrowserCompat.DEBUG) {
                    dump();
                }
        ...
        public void getItem(@NonNull String str, @NonNull ItemCallback itemCallback) {
            if (TextUtils.isEmpty(str)) {
                ...
                Log.i(MediaBrowserCompat.TAG, "Not connected, unable to retrieve the MediaItem.");
                this.mHandler.post(new C00462(itemCallback, str));
            } else {
                try {
                    this.mServiceBinderWrapper.getMediaItem(str, new ItemReceiver(str, itemCallback, this.mHandler), this.mCallbacksMessenger);
                } catch (RemoteException e) {
                    Log.i(MediaBrowserCompat.TAG, "Remote error getting media item.");
                    this.mHandler.post(new C00473(itemCallback, str));
                }
            }
        }
        ...
        public void onLoadChildren(Messenger messenger, String str, List list, Bundle bundle) {
            if (isCurrent(messenger, "onLoadChildren")) {
                if (MediaBrowserCompat.DEBUG) {
                    new StringBuilder("onLoadChildren for ").append(this.mServiceComponent).append(" id=").append(str);
                }
                Subscription subscription = (Subscription) this.mSubscriptions.get(str);
                if (subscription == null) {
                    boolean z = MediaBrowserCompat.DEBUG;
