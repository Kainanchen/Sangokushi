...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C01392 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    class C01403 implements Callback {
        C01403() {
        }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation c01381 = new C01381(ring);
        c01381.setRepeatCount(-1);
        c01381.setRepeatMode(DEFAULT);
        c01381.setInterpolator(LINEAR_INTERPOLATOR);
        c01381.setAnimationListener(new C01392(ring));
        this.mAnimation = c01381;
    }
}
