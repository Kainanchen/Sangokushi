...
public class ViewDragHelper {
    ...
    static class C01551 implements Interpolator {
        C01551() {
        }
    ...
    private ViewDragHelper(Context context, ViewGroup viewGroup, Callback callback) {
        ...
        this.mSetIdleRunnable = new C01562();
        if (viewGroup == null) {
    ...
    public boolean checkTouchSlop(int i, int i2) {
        ...
        boolean z;
        boolean z2 = (i & STATE_DRAGGING) == STATE_DRAGGING ? STATE_DRAGGING : false;
        ...
        if (z2 && z) {
            ...
            return false;
        } else if (!z || Math.abs(f2) <= ((float) this.mTouchSlop)) {
            return false;
        } else {
            return true;
        }
