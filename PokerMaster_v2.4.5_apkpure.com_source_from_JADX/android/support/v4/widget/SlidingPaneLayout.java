...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C01461 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01461() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01461());
        }
    }
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.height == -2) {
                    makeMeasureSpec = MeasureSpec.makeMeasureSpec(size2, RtlSpacingHelper.UNDEFINED);
                        ...
                        if (!z || childAt2 == this.mSlideableView) {
                            if (layoutParams.weight > 0.0f) {
                                if (layoutParams.width != 0) {
                                    ...
                                    mode = MeasureSpec.makeMeasureSpec(size2, RtlSpacingHelper.UNDEFINED);
                                } else if (layoutParams.height == -1) {
                            ...
                            if (obj == null) {
                                ...
                                mode2 = MeasureSpec.makeMeasureSpec(size2, RtlSpacingHelper.UNDEFINED);
                            } else if (layoutParams.height == -1) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    if (!this.mCanSlide || this.mParallaxBy == 0) {
                        ...
                        i9 = (int) ((DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - this.mSlideOffset) * ((float) this.mParallaxBy));
                    }
                    i11 = i9;
                    i10 = paddingRight;
                }
            ...
            if ((isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin) <= 0) {
                ...
                for (i = 0; i < childCount; i++) {
                    ...
                    if (childAt != this.mSlideableView) {
                        ...
                        if (obj == null) {
                            if (isLayoutRtlSupport) {
                                f2 = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - this.mParallaxOffset;
                            } else {
                                f2 = this.mParallaxOffset - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
                            }
