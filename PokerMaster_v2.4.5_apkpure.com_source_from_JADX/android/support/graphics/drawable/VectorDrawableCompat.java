...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VPath {
        ...
        public void printVPath(int i) {
            ...
            new StringBuilder().append(str).append("current path is :").append(this.mPathName).append(" pathData is ").append(NodesToString(this.mNodes));
        }
    ...
    private static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i, int i2, ColorFilter colorFilter) {
            ...
            if (f != 0.0f) {
                ...
                if (!(vFullPath.mTrimPathStart == 0.0f && vFullPath.mTrimPathEnd == DefaultRetryPolicy.DEFAULT_BACKOFF_MULT)) {
                    float f3 = (vFullPath.mTrimPathStart + vFullPath.mTrimPathOffset) % DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
                    float f4 = (vFullPath.mTrimPathEnd + vFullPath.mTrimPathOffset) % DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        new StringBuilder().append(str).append("current group is :").append(vGroup.getGroupName()).append(" rotation is ").append(vGroup.mRotate);
        new StringBuilder().append(str).append("matrix is :").append(vGroup.getLocalMatrix().toString());
    ...
    private boolean needMirroring() {
        if (VERSION.SDK_INT >= 17 && isAutoMirrored() && getLayoutDirection() == LINEJOIN_ROUND) {
            return true;
        }
        return DBG_VECTOR_DRAWABLE;
    }
