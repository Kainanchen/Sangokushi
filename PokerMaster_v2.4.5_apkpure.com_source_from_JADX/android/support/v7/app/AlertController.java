...
class AlertController {
    ...
    class C01592 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01592(View view, View view2) {
            this.val$top = view;
    ...
    class C01614 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01614(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C01631 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ RecycleListView val$listView;

            C01631(Context context, int i, int i2, CharSequence[] charSequenceArr, RecycleListView recycleListView) {
        ...
        class C01642 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ RecycleListView val$listView;

            C01642(Context context, Cursor cursor, boolean z, RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
        ...
        class C01653 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;

            C01653(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C01664 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ RecycleListView val$listView;

            C01664(RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                simpleCursorAdapter = new C01631(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems, recycleListView);
            } else {
                Object c01642 = new C01642(this.mContext, this.mCursor, false, recycleListView, alertController);
            }
            ...
            if (this.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new C01653(alertController));
            } else if (this.mOnCheckboxClickListener != null) {
                recycleListView.setOnItemClickListener(new C01664(recycleListView, alertController));
            }
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0184R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0184R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        this.mButtonHandler = new C01581();
        this.mContext = context;
        this.mDialog = appCompatDialog;
        this.mWindow = window;
        this.mHandler = new ButtonHandler(appCompatDialog);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0184R.styleable.AlertDialog, C0184R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0184R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0184R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0184R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0184R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0184R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0184R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0184R.styleable.AlertDialog_showTitle, true);
    ...
    private void setupView() {
        boolean z;
        boolean z2;
        View findViewById = this.mWindow.findViewById(C0184R.id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0184R.id.topPanel);
        View findViewById3 = findViewById.findViewById(C0184R.id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0184R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0184R.id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0184R.id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0184R.id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0184R.id.buttonPanel);
        ...
        if (!(z2 || resolvePanel2 == null)) {
            findViewById = resolvePanel2.findViewById(C0184R.id.textSpacerNoButtons);
        ...
        if (z) {
            ...
            if (!((this.mMessage == null && this.mListView == null && !z3) || z3)) {
                findViewById = resolvePanel.findViewById(C0184R.id.titleDividerNoCustom);
            }
            if (findViewById != null) {
                findViewById.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            findViewById = resolvePanel2.findViewById(C0184R.id.textSpacerNoTitle);
            if (findViewById != null) {
                findViewById.setVisibility(0);
            }
        }
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View view2 = null;
        View findViewById = this.mWindow.findViewById(C0184R.id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0184R.id.scrollIndicatorDown);
        ...
        if (findViewById != null || view2 != null) {
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C01592(findViewById, view2));
                this.mScrollView.post(new C01603(findViewById, view2));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C01614(findViewById, view2));
                this.mListView.post(new C01625(findViewById, view2));
            } else {
                if (findViewById != null) {
                    viewGroup.removeView(findViewById);
                }
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0184R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0184R.id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0184R.id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0184R.id.scrollView);
