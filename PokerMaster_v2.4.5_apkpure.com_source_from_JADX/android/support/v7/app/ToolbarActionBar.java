...
class ToolbarActionBar extends ActionBar {
    ...
    class C01802 implements OnMenuItemClickListener {
        C01802() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public final boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            ...
            ToolbarActionBar.this.mWindowCallback.onMenuOpened(R.AppCompatTheme_ratingBarStyle, menuBuilder);
            return true;
        }
        ...
        public final void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            if (!this.mClosingActionMenu) {
                ...
                if (ToolbarActionBar.this.mWindowCallback != null) {
                    ToolbarActionBar.this.mWindowCallback.onPanelClosed(R.AppCompatTheme_ratingBarStyle, menuBuilder);
                }
    ...
    public ToolbarActionBar(Toolbar toolbar, CharSequence charSequence, Callback callback) {
        ...
        this.mMenuInvalidator = new C01791();
        this.mMenuClicker = new C01802();
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(contextThemeWrapper, C0184R.layout.abc_list_menu_item_layout);
