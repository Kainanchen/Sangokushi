...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0184R.styleable.ActionBarLayout);
            this.gravity = obtainStyledAttributes.getInt(C0184R.styleable.ActionBarLayout_android_layout_gravity, ActionBar.NAVIGATION_MODE_STANDARD);
