...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    class C01691 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV9.this.mInvalidatePanelMenuFeatures & CodedOutputStream.DEFAULT_BUFFER_SIZE) != 0) {
                AppCompatDelegateImplV9.this.doInvalidatePanelMenu(R.AppCompatTheme_ratingBarStyle);
            }
    ...
    class C01702 implements OnApplyWindowInsetsListener {
        C01702() {
        }
    ...
    class C01713 implements OnFitSystemWindowsListener {
        C01713() {
        }
    ...
    class C01724 implements OnAttachListener {
        C01724() {
        }
    ...
    class C01745 implements Runnable {
        ...
        class C01731 extends ViewPropertyAnimatorListenerAdapter {
            C01731() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C01731());
                return;
            }
            ViewCompat.setAlpha(AppCompatDelegateImplV9.this.mActionModeView, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    class C01756 extends ViewPropertyAnimatorListenerAdapter {
        C01756() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public final boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            ...
            if (windowCallback != null) {
                windowCallback.onMenuOpened(R.AppCompatTheme_ratingBarStyle, menuBuilder);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C01761 extends ViewPropertyAnimatorListenerAdapter {
            C01761() {
            }
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C01761());
            }
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C01771());
            }
        }
        ...
        final void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0184R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0184R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0184R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context contextThemeWrapper = new ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0184R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0184R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0184R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
        ...
        final MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0184R.layout.abc_list_menu_item_layout);
    ...
    AppCompatDelegateImplV9(Context context, Window window, AppCompatCallback appCompatCallback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C01691();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (panelState == null || panelState.menu == null) {
                    invalidatePanelMenu(R.AppCompatTheme_ratingBarStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0184R.styleable.AppCompatTheme);
        if (obtainStyledAttributes.hasValue(C0184R.styleable.AppCompatTheme_windowActionBar)) {
            View view;
            if (obtainStyledAttributes.getBoolean(C0184R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0184R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(R.AppCompatTheme_ratingBarStyle);
            }
            if (obtainStyledAttributes.getBoolean(C0184R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(R.AppCompatTheme_ratingBarStyleIndicator);
            }
            if (obtainStyledAttributes.getBoolean(C0184R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0184R.styleable.AppCompatTheme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            ...
            if (this.mWindowNoTitle) {
                ...
                if (this.mOverlayActionMode) {
                    view2 = (ViewGroup) from.inflate(C0184R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    view2 = (ViewGroup) from.inflate(C0184R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view2, new C01702());
                    view = view2;
                } else {
                    ((FitWindowsViewGroup) view2).setOnFitSystemWindowsListener(new C01713());
                    view = view2;
                }
            } else if (this.mIsFloating) {
                r0 = (ViewGroup) from.inflate(C0184R.layout.abc_dialog_title_material, null);
                ...
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0184R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    contextThemeWrapper = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    contextThemeWrapper = this.mContext;
                }
                r0 = (ViewGroup) LayoutInflater.from(contextThemeWrapper).inflate(C0184R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) r0.findViewById(C0184R.id.decor_content_parent);
                this.mDecorContentParent.setWindowCallback(getWindowCallback());
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(R.AppCompatTheme_ratingBarStyleIndicator);
                }
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) view.findViewById(C0184R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(view);
            ContentFrameLayout contentFrameLayout = (ContentFrameLayout) view.findViewById(C0184R.id.action_bar_activity_content);
            ...
            contentFrameLayout.setAttachListener(new C01724());
            return view;
        }
        obtainStyledAttributes.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0184R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0184R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0184R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0184R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0184R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0184R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0184R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0184R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0184R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0184R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0184R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
    ...
    public boolean requestWindowFeature(int i) {
        ...
        if (this.mWindowNoTitle && sanitizeWindowFeatureId == R.AppCompatTheme_ratingBarStyle) {
            return false;
        }
    ...
    void onPanelClosed(int i, Menu menu) {
        if (i == R.AppCompatTheme_ratingBarStyle) {
            ActionBar supportActionBar = getSupportActionBar();
            if (supportActionBar != null) {
        ...
        if (!(this.mAppCompatCallback == null || isDestroyed())) {
            ...
            if (onWindowStartingSupportActionMode == null) {
                ...
                if (this.mActionModeView == null) {
                    if (this.mIsFloating) {
                        viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(C0184R.id.action_mode_bar_stub);
                        ...
                        theme.resolveAttribute(C0184R.attr.actionBarTheme, typedValue, true);
                        if (typedValue.resourceId == 0) {
                        ...
                        this.mActionModePopup = new PopupWindow(contextThemeWrapper, null, C0184R.attr.actionModePopupWindowStyle);
                        PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                        this.mActionModePopup.setContentView(this.mActionModeView);
                        this.mActionModePopup.setWidth(-1);
                        contextThemeWrapper.getTheme().resolveAttribute(C0184R.attr.actionBarSize, typedValue, true);
                        ...
                        this.mShowActionModePopup = new C01745();
                    }
                }
                if (this.mActionModeView != null) {
                    endOnGoingFadeAnimation();
                    ...
                    if (callback.onCreateActionMode(standaloneActionMode, standaloneActionMode.getMenu())) {
                        ...
                        if (shouldAnimateActionModeView()) {
                            ...
                            this.mFadeAnim.setListener(new C01756());
                        }
                        if (this.mActionModePopup != null) {
    ...
    private void reopenMenu(MenuBuilder menuBuilder, boolean z) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && z) {
            ...
            if (!isDestroyed()) {
                windowCallback.onPanelClosed(R.AppCompatTheme_ratingBarStyle, getPanelState(0, true).menu);
            }
            ...
            if (panelState2.menu != null && !panelState2.refreshMenuContent && windowCallback.onPreparePanel(0, panelState2.createdPanelView, panelState2.menu)) {
                windowCallback.onMenuOpened(R.AppCompatTheme_ratingBarStyle, panelState2.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == R.AppCompatTheme_ratingBarStyle) && this.mDecorContentParent != null) {
            TypedValue typedValue = new TypedValue();
            ...
            if (typedValue.resourceId != 0) {
                ...
                theme2.resolveAttribute(C0184R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0184R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        boolean z = panelFeatureState.featureId == 0 || panelFeatureState.featureId == R.AppCompatTheme_ratingBarStyle;
    ...
    void checkCloseActionMenu(MenuBuilder menuBuilder) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback windowCallback = getWindowCallback();
            if (!(windowCallback == null || isDestroyed())) {
                windowCallback.onPanelClosed(R.AppCompatTheme_ratingBarStyle, menuBuilder);
            }
    ...
    void doInvalidatePanelMenu(int i) {
        ...
        panelState.refreshDecorView = true;
        if ((i == R.AppCompatTheme_ratingBarStyle || i == 0) && this.mDecorContentParent != null) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0184R.color.abc_input_method_navigation_guard));
    ...
    private int sanitizeWindowFeatureId(int i) {
        if (i == 8) {
            ...
            return R.AppCompatTheme_ratingBarStyle;
        } else if (i != 9) {
            return i;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return R.AppCompatTheme_ratingBarStyleIndicator;
        }
    }
