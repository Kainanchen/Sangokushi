...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    static class C01671 implements UncaughtExceptionHandler {
        final /* synthetic */ UncaughtExceptionHandler val$defHandler;

        C01671(UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), null, new int[]{C0184R.attr.homeAsUpIndicator});
    ...
    static {
        boolean z = VERSION.SDK_INT < 21 ? true : DEBUG;
        SHOULD_INSTALL_EXCEPTION_HANDLER = z;
        if (z && !sInstalledExceptionHandler) {
            Thread.setDefaultUncaughtExceptionHandler(new C01671(Thread.getDefaultUncaughtExceptionHandler()));
