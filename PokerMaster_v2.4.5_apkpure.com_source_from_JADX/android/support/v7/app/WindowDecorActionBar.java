...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C01822 extends ViewPropertyAnimatorListenerAdapter {
        C01822() {
        }
    ...
    class C01833 implements ViewPropertyAnimatorUpdateListener {
        C01833() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean z) {
        ...
        this.mHideListener = new C01811();
        this.mShowListener = new C01822();
        this.mUpdateListener = new C01833();
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0184R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0184R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0184R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0184R.id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0184R.styleable.ActionBar, C0184R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0184R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0184R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0184R.attr.actionBarWidgetTheme, typedValue, true);
