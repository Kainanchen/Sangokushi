...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    class C01871 implements OnGlobalLayoutListener {
        C01871() {
        }
    ...
    class C01892 implements MenuItemHoverListener {
        ...
        class C01881 implements Runnable {
            ...
            C01881(CascadingMenuInfo cascadingMenuInfo, MenuItem menuItem, MenuBuilder menuBuilder) {
        ...
        public void onItemHoverEnter(@NonNull MenuBuilder menuBuilder, @NonNull MenuItem menuItem) {
            ...
            if (i != -1) {
                ...
                CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new C01881(cascadingMenuInfo, menuItem, menuBuilder), menuBuilder, SystemClock.uptimeMillis() + 200);
            }
        }
    }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mGlobalLayoutListener = new C01871();
        this.mMenuItemHoverListener = new C01892();
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0184R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            ...
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0184R.layout.abc_popup_menu_header_item_layout, listView, false);
