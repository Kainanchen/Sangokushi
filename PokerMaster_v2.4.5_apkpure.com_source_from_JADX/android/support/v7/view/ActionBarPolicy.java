...
public class ActionBarPolicy {
    ...
    public boolean hasEmbeddedTabs() {
        return this.mContext.getResources().getBoolean(C0184R.bool.abc_action_bar_embed_tabs);
    }
    ...
    public int getTabContainerHeight() {
        ...
        int layoutDimension = obtainStyledAttributes.getLayoutDimension(C0184R.styleable.ActionBar_height, 0);
        Resources resources = this.mContext.getResources();
        if (!hasEmbeddedTabs()) {
            layoutDimension = Math.min(layoutDimension, resources.getDimensionPixelSize(C0184R.dimen.abc_action_bar_stacked_max_height));
        }
    ...
    public int getStackedTabMaxWidth() {
        return this.mContext.getResources().getDimensionPixelSize(C0184R.dimen.abc_action_bar_stacked_tab_max_width);
    }
}
