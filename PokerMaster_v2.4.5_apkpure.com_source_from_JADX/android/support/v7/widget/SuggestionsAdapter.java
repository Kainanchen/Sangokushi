...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0184R.id.edit_query);
        }
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        String charSequence2 = charSequence == null ? LetterIndexBar.SEARCH_ICON_LETTER : charSequence.toString();
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0184R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0184R.attr.textColorSearchUrl, typedValue, true);
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        String[] strArr;
        Builder fragment = new Builder().scheme(MessageKey.MSG_CONTENT).authority(suggestAuthority).query(LetterIndexBar.SEARCH_ICON_LETTER).fragment(LetterIndexBar.SEARCH_ICON_LETTER);
