...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        ...
        this.mShadowStartColor = resources.getColor(C0185R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0185R.color.cardview_shadow_end_color);
    ...
    private void buildShadowCorners() {
        ...
        float f2 = 0.0f;
        this.mEdgeShadowPaint.setShader(new LinearGradient(0.0f, (-this.mCornerRadius) + this.mShadowSize, f2, (-this.mCornerRadius) - this.mShadowSize, new int[]{this.mShadowStartColor, this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, 0.5f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT}, TileMode.CLAMP));
        this.mEdgeShadowPaint.setAntiAlias(false);
    }
