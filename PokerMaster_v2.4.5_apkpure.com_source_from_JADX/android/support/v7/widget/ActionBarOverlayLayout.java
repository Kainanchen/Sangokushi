...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    class C01951 extends ViewPropertyAnimatorListenerAdapter {
        C01951() {
        }
    ...
    static {
        ATTRS = new int[]{C0184R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C01951();
        this.mRemoveActionBarHideOffset = new C01962();
        this.mAddActionBarHideOffset = new C01973();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0184R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0184R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0184R.id.action_bar));
        }
    }
