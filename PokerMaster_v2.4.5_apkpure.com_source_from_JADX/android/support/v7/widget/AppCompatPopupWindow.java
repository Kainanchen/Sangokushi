...
class AppCompatPopupWindow extends PopupWindow {
    ...
    static class C02041 implements OnScrollChangedListener {
        ...
        C02041(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0184R.styleable.PopupWindow, i, i2);
        if (obtainStyledAttributes.hasValue(C0184R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(obtainStyledAttributes.getBoolean(C0184R.styleable.PopupWindow_overlapAnchor, COMPAT_OVERLAP_ANCHOR));
        }
        setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0184R.styleable.PopupWindow_android_popupBackground));
        int i3 = VERSION.SDK_INT;
        if (i2 != 0 && i3 < 11 && obtainStyledAttributes.hasValue(C0184R.styleable.PopupWindow_android_popupAnimationStyle)) {
            setAnimationStyle(obtainStyledAttributes.getResourceId(C0184R.styleable.PopupWindow_android_popupAnimationStyle, -1));
        }
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popupWindow) {
        try {
            ...
            declaredField2.set(popupWindow, new C02041(declaredField, popupWindow, (OnScrollChangedListener) declaredField2.get(popupWindow)));
        } catch (Exception e) {
        }
    }
