...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C02051 extends ForwardingListener {
        ...
        C02051(View view, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C02061 implements OnItemClickListener {
            ...
            C02061(AppCompatSpinner appCompatSpinner) {
        ...
        class C02072 implements OnGlobalLayoutListener {
            C02072() {
            }
        ...
        class C02083 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C02083(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attributeSet, int i) {
            ...
            setOnItemClickListener(new C02061(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!isShowing) {
                ViewTreeObserver viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver();
                if (viewTreeObserver != null) {
                    OnGlobalLayoutListener c02072 = new C02072();
                    viewTreeObserver.addOnGlobalLayoutListener(c02072);
                    setOnDismissListener(new C02083(c02072));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, C0184R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0184R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet, int i, int i2, Theme theme) {
        ...
        TintTypedArray obtainStyledAttributes3 = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0184R.styleable.Spinner, i, MODE_DIALOG);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (theme != null) {
            contextThemeWrapper = new ContextThemeWrapper(context, theme);
            appCompatSpinner = this;
        } else {
            int resourceId = obtainStyledAttributes3.getResourceId(C0184R.styleable.Spinner_popupTheme, MODE_DIALOG);
            if (resourceId != 0) {
        ...
        appCompatSpinner.mPopupContext = contextThemeWrapper;
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (i2 == MODE_DROPDOWN) {
                                    ...
                                    obtainStyledAttributes2 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, C0184R.styleable.Spinner, i, MODE_DIALOG);
                                    this.mDropDownWidth = obtainStyledAttributes2.getLayoutDimension(C0184R.styleable.Spinner_android_dropDownWidth, -2);
                                    dropdownPopup.setBackgroundDrawable(obtainStyledAttributes2.getDrawable(C0184R.styleable.Spinner_android_popupBackground));
                                    dropdownPopup.setPromptText(obtainStyledAttributes3.getString(C0184R.styleable.Spinner_android_prompt));
                                    obtainStyledAttributes2.recycle();
                                    this.mPopup = dropdownPopup;
                                    this.mForwardingListener = new C02051(this, dropdownPopup);
                                }
                                textArray = obtainStyledAttributes3.getTextArray(C0184R.styleable.Spinner_android_entries);
                                if (textArray != null) {
                                    arrayAdapter = new ArrayAdapter(context, 17367048, textArray);
                                    arrayAdapter.setDropDownViewResource(C0184R.layout.support_simple_spinner_dropdown_item);
