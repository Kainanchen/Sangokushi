...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            if (drawable == null) {
                tintTypedArray = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, C0184R.styleable.AppCompatImageView, i, 0);
                int resourceId = tintTypedArray.getResourceId(C0184R.styleable.AppCompatImageView_srcCompat, -1);
                if (resourceId != -1) {
