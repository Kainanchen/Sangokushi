...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C02121 implements OnAttachStateChangeListener {
        C02121() {
        }
    ...
    private void addDetachListenerApi12(View view) {
        view.addOnAttachStateChangeListener(new C02121());
    }

    private void addDetachListenerBase(View view) {
        view.getViewTreeObserver().addOnGlobalLayoutListener(new C02132());
    }
