...
class CardViewGingerbread implements CardViewImpl {
    ...
    class C02101 implements RoundRectHelper {
        C02101() {
        }

        public void drawRoundRect(Canvas canvas, RectF rectF, float f, Paint paint) {
            float f2 = 2.0f * f;
            float width = (rectF.width() - f2) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
            float height = (rectF.height() - f2) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
            if (f >= DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) {
                ...
                canvas.drawRect((rectF.left + f3) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, rectF.top, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + (rectF.right - f3), rectF.top + f3, paint);
                canvas.drawRect((rectF.left + f3) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, rectF.bottom - f3, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + (rectF.right - f3), rectF.bottom, paint);
            }
    ...
    public void initStatic() {
        RoundRectDrawableWithShadow.sRoundRectHelper = new C02101();
    }
