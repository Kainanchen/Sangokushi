...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0184R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0184R.styleable.SwitchCompat, i, 0);
        this.mThumbDrawable = obtainStyledAttributes.getDrawable(C0184R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = obtainStyledAttributes.getDrawable(C0184R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = obtainStyledAttributes.getText(C0184R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = obtainStyledAttributes.getText(C0184R.styleable.SwitchCompat_android_textOff);
        this.mShowText = obtainStyledAttributes.getBoolean(C0184R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(C0184R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0184R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(C0184R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(C0184R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0184R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0184R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        colorStateList = obtainStyledAttributes.getColorStateList(C0184R.styleable.SwitchCompat_trackTint);
        if (colorStateList != null) {
            this.mTrackTintList = colorStateList;
            this.mHasTrackTint = true;
        }
        parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0184R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(C0184R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0184R.styleable.TextAppearance_android_textSize, 0);
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(C0184R.styleable.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(C0184R.styleable.TextAppearance_android_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(C0184R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        intrinsicWidth = Math.max(this.mSwitchMinWidth, (intrinsicWidth + (this.mThumbWidth * TOUCH_MODE_DRAGGING)) + max);
    ...
    private Layout makeLayout(CharSequence charSequence) {
        ...
        return new StaticLayout(transformation, textPaint, ceil, Alignment.ALIGN_NORMAL, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f, true);
    }
            ...
            case TOUCH_MODE_DRAGGING /*2*/:
                switch (this.mTouchMode) {
                    ...
                    case TOUCH_MODE_DRAGGING /*2*/:
                        ...
                        x = thumbScrollRange != 0 ? f / ((float) thumbScrollRange) : f > 0.0f ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : -1.0f;
    ...
    private void animateThumbToCheckedState(boolean z) {
        ...
        this.mPositionAnimator.setAnimationListener(new C02311(z));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        switch (getGravity() & R.AppCompatTheme_spinnerStyle) {
