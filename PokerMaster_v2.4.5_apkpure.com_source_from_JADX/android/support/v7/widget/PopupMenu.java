...
public class PopupMenu {
    ...
    class C02182 implements android.widget.PopupWindow.OnDismissListener {
        C02182() {
        }
    ...
    class C02193 extends ForwardingListener {
        C02193(View view) {
            super(view);
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View view, int i) {
        this(context, view, i, C0184R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View view, int i, @AttrRes int i2, @StyleRes int i3) {
        ...
        this.mMenu.setCallback(new C02171());
        this.mPopup = new MenuPopupHelper(context, this.mMenu, view, false, i2, i3);
        this.mPopup.setGravity(i);
        this.mPopup.setOnDismissListener(new C02182());
    }
    ...
    public OnTouchListener getDragToOpenListener() {
        if (this.mDragListener == null) {
            this.mDragListener = new C02193(this.mAnchor);
        }
