...
public class ListPopupWindow implements ShowableListMenu {
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0184R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0184R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0184R.styleable.ListPopupWindow, i, i2);
        this.mDropDownHorizontalOffset = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
        ...
        if (isShowing() && i != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(i))) {
            ...
            if (listAdapter != null) {
                ...
                if (areAllItemsEnabled) {
                    ...
                    i3 = this.mDropDownList.lookForSelectablePosition(POSITION_PROMPT_ABOVE, true);
                }
                if (areAllItemsEnabled) {
                    i2 = listAdapter.getCount() + MATCH_PARENT;
                } else {
                    i2 = this.mDropDownList.lookForSelectablePosition(listAdapter.getCount() + MATCH_PARENT, DEBUG);
                }
                int i4 = i3;
                i3 = i2;
                i2 = i4;
            }
            if (!(z && i == 19 && selectedItemPosition <= r3) && (z || i != 20 || selectedItemPosition < i3)) {
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            if (view3 != null) {
                ...
                ViewGroup.LayoutParams layoutParams2 = new LayoutParams(MATCH_PARENT, POSITION_PROMPT_ABOVE, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
