...
public class Toolbar extends ViewGroup {
    ...
    class C02321 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C02321() {
        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                generateDefaultLayoutParams.gravity = GravityCompat.START | (Toolbar.this.mButtonGravity & R.AppCompatTheme_spinnerStyle);
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0184R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuViewItemClickListener = new C02321();
        this.mShowOverflowMenuRunnable = new C02332();
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, C0184R.styleable.Toolbar, i, 0);
        this.mTitleTextAppearance = obtainStyledAttributes.getResourceId(C0184R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = obtainStyledAttributes.getResourceId(C0184R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = obtainStyledAttributes.getInteger(C0184R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = obtainStyledAttributes.getInteger(C0184R.styleable.Toolbar_buttonGravity, 48);
        int dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_titleMargin, 0);
        if (obtainStyledAttributes.hasValue(C0184R.styleable.Toolbar_titleMargins)) {
            dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_titleMargins, dimensionPixelOffset);
        }
        this.mTitleMarginBottom = dimensionPixelOffset;
        this.mTitleMarginTop = dimensionPixelOffset;
        this.mTitleMarginEnd = dimensionPixelOffset;
        this.mTitleMarginStart = dimensionPixelOffset;
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_titleMarginStart, -1);
        if (dimensionPixelOffset >= 0) {
            this.mTitleMarginStart = dimensionPixelOffset;
        }
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_titleMarginEnd, -1);
        if (dimensionPixelOffset >= 0) {
            this.mTitleMarginEnd = dimensionPixelOffset;
        }
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_titleMarginTop, -1);
        if (dimensionPixelOffset >= 0) {
            this.mTitleMarginTop = dimensionPixelOffset;
        }
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_titleMarginBottom, -1);
        if (dimensionPixelOffset >= 0) {
            this.mTitleMarginBottom = dimensionPixelOffset;
        }
        this.mMaxButtonHeight = obtainStyledAttributes.getDimensionPixelSize(C0184R.styleable.Toolbar_maxButtonHeight, -1);
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_contentInsetStart, RtlSpacingHelper.UNDEFINED);
        int dimensionPixelOffset2 = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_contentInsetEnd, RtlSpacingHelper.UNDEFINED);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0184R.styleable.Toolbar_contentInsetLeft, 0);
        int dimensionPixelSize2 = obtainStyledAttributes.getDimensionPixelSize(C0184R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_contentInsetStartWithNavigation, RtlSpacingHelper.UNDEFINED);
        this.mContentInsetEndWithActions = obtainStyledAttributes.getDimensionPixelOffset(C0184R.styleable.Toolbar_contentInsetEndWithActions, RtlSpacingHelper.UNDEFINED);
        this.mCollapseIcon = obtainStyledAttributes.getDrawable(C0184R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = obtainStyledAttributes.getText(C0184R.styleable.Toolbar_collapseContentDescription);
        CharSequence text = obtainStyledAttributes.getText(C0184R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(text)) {
            setTitle(text);
        }
        text = obtainStyledAttributes.getText(C0184R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(text)) {
            setSubtitle(text);
        }
        this.mPopupContext = getContext();
        setPopupTheme(obtainStyledAttributes.getResourceId(C0184R.styleable.Toolbar_popupTheme, 0));
        Drawable drawable = obtainStyledAttributes.getDrawable(C0184R.styleable.Toolbar_navigationIcon);
        if (drawable != null) {
            setNavigationIcon(drawable);
        }
        text = obtainStyledAttributes.getText(C0184R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(text)) {
            setNavigationContentDescription(text);
        }
        drawable = obtainStyledAttributes.getDrawable(C0184R.styleable.Toolbar_logo);
        if (drawable != null) {
            setLogo(drawable);
        }
        text = obtainStyledAttributes.getText(C0184R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(text)) {
            setLogoDescription(text);
        }
        if (obtainStyledAttributes.hasValue(C0184R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(obtainStyledAttributes.getColor(C0184R.styleable.Toolbar_titleTextColor, -1));
        }
        if (obtainStyledAttributes.hasValue(C0184R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(obtainStyledAttributes.getColor(C0184R.styleable.Toolbar_subtitleTextColor, -1));
        }
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            generateDefaultLayoutParams.gravity = GravityCompat.END | (this.mButtonGravity & R.AppCompatTheme_spinnerStyle);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0184R.attr.toolbarNavigationButtonStyle);
            android.view.ViewGroup.LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
            generateDefaultLayoutParams.gravity = GravityCompat.START | (this.mButtonGravity & R.AppCompatTheme_spinnerStyle);
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0184R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C02343());
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i3 < i4) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                ...
                i6 = ViewUtils.combineMeasuredStates(i5, ViewCompat.getMeasuredState(childAt));
        ...
        i6 = ViewCompat.resolveSizeAndState(Math.max(i6, getSuggestedMinimumHeight()), i2, i5 << 16);
        if (shouldCollapse()) {
            i6 = 0;
        }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (measuredWidth < paddingLeft) {
            minimumHeight = layoutChildLeft((View) this.mTempViews.get(measuredWidth), i5, iArr, min);
            measuredWidth++;
            i5 = minimumHeight;
        }
    ...
    private int getViewListMeasuredWidth(List<View> list, int[] iArr) {
        ...
        while (i3 < size) {
            ...
            i5 = layoutParams.leftMargin - i5;
            i2 = layoutParams.rightMargin - i6;
    ...
    private int getChildVerticalGravity(int i) {
        ...
        switch (i2) {
            ...
            case R.AppCompatTheme_panelMenuListWidth /*80*/:
                return i2;
            default:
                return this.mGravity & R.AppCompatTheme_spinnerStyle;
        }
    }
