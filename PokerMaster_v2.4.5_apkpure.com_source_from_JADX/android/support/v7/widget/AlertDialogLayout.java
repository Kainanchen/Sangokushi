...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        while (i6 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                id = childAt.getId();
                if (id == C0184R.id.topPanel) {
                    View view4 = view2;
                    view2 = childAt;
                    childAt = view4;
                } else if (id == C0184R.id.buttonPanel) {
                    view2 = view;
                } else if (id != C0184R.id.contentPanel && id != C0184R.id.customPanel) {
                    return false;
                } else {
                    if (view3 != null) {
                        return false;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        switch (gravity & R.AppCompatTheme_spinnerStyle) {
