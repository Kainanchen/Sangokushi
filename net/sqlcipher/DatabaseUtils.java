...
public class DatabaseUtils {
    ...
    private static final String[] countProjection = null;
    ...
    public static class InsertHelper {
        ...
        static {
            fixHelper.fixfunc(new int[]{19349, 19350, 19351, 19352, 19353, 19354, 19355, 19356, 19357, 19358, 19359, 19360, 19361, 19362, 19363, 19364, 19365, 19366, 19367});
            if (VERSION.SDK_INT <= 0) {
                Exists0.class.toString();
            }
        }

        public native InsertHelper(SQLiteDatabase sQLiteDatabase, String str);

        private native void buildSQL();

        private native SQLiteStatement getStatement(boolean z);
    ...
    static {
        fixHelper.fixfunc(new int[]{30427, 1});
        __clinit__();
        if (VERSION.SDK_INT <= 0) {
            Exists0.class.toString();
        }
