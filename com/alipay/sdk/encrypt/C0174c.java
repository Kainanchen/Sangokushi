...
public final class C0174c {
    public static byte[] m504a(byte[] bArr) throws IOException {
    ...
    public static byte[] m505b(byte[] bArr) throws IOException {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    while (true) {
                        try {
                            int read = gZIPInputStream.read(bArr2, 0, AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD);
                            if (read == -1) {
                                break;
                            }
