...
public class NetworkImageView extends ImageView {
    ...
    class C02251 implements ImageListener {
        ...
        class C02241 implements Runnable {
            ...
            C02241(ImageContainer imageContainer) {
                this.val$response = imageContainer;
            }

            public void run() {
                C02251.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new C02241(response));
    ...
    private void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        boolean isFullyWrapContent = getLayoutParams().height == -2 && getLayoutParams().width == -2;
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new C02251(isInLayoutPass));
        }
    }
