...
public class ImageLoader {
    ...
    class C02201 implements ImageListener {
        ...
        C02201(int i, ImageView imageView, int i2) {
    ...
    class C02212 implements Listener<Bitmap> {
    ...
    class C02223 implements ErrorListener {
        private final /* synthetic */ String val$cacheKey;
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new C02201(errorImageResId, view, defaultImageResId);
    }
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight) {
        ...
        Request<?> newRequest = new ImageRequest(requestUrl, new C02212(cacheKey), maxWidth, maxHeight, Config.RGB_565, new C02223(cacheKey));
