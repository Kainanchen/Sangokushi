...
public class VolleyLog {
    ...
    static class MarkerLog {
        ...
        public synchronized void finish(String header) {
            ...
            if (getTotalDuration() > 0) {
                ...
                VolleyLog.m716d("(%-4d ms) %s", Long.valueOf(duration), header);
                for (Marker marker : this.mMarkers) {
                    VolleyLog.m716d("(+%-4d) [%2d] %s", Long.valueOf(marker.time - prevTime), Long.valueOf(marker.thread), marker.name);
        ...
        protected void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m717e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
    ...
    public static void m719v(String format, Object... args) {
        System.out.println(" ####### VolleyTag V ######### " + DEBUG);
        if (DEBUG) {
            Log.v(TAG, buildMessage(format, args));
        }
    }

    public static void m716d(String format, Object... args) {
        Log.d(TAG, buildMessage(format, args));
    }

    public static void m717e(String format, Object... args) {
        Log.e(TAG, buildMessage(format, args));
    }

    public static void m718e(Throwable tr, String format, Object... args) {
