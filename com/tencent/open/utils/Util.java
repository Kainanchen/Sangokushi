...
public class Util {
    ...
    private static String f1748f;
    private static String f1749g;

    /* renamed from: com.tencent.open.utils.Util.1 */
    static class ProGuard extends Thread {
        final /* synthetic */ Context f1740a;
        final /* synthetic */ Bundle f1741b;

        ProGuard(Context context, Bundle bundle) {
            this.f1740a = context;
            this.f1741b = bundle;
        }
        ...
        public void run() {
            try {
                HttpUtils.openUrl2(this.f1740a, "http://cgi.qplus.com/report/report", Constants.HTTP_GET, this.f1741b);
            } catch (Exception e) {
                com.tencent.open.p067a.ProGuard.m2122e("openSDK_LOG.Util", "reportBernoulli has exception: " + e.getMessage());
            }
        }
    }
    ...
    static {
        f1743a = Constants.STR_EMPTY;
        f1744b = Constants.STR_EMPTY;
        f1745c = Constants.STR_EMPTY;
        f1746d = Constants.STR_EMPTY;
        f1747e = -1;
        f1749g = "0123456789ABCDEF";
    }
    ...
    public static Bundle decodeUrl(String str) {
        ...
        try {
            for (String split : str.split(C0190a.f451b)) {
            ...
            for (String split : str.split(C0190a.f451b)) {
                ...
                if (split2.length == 2) {
                    try {
                        ...
                        com.tencent.open.p067a.ProGuard.m2122e("openSDK_LOG.Util", "decodeUrlToJson has exception: " + e.getMessage());
                    }
                }
            }
        }
    ...
    public static Statistic upload(Context context, String str, Bundle bundle) throws MalformedURLException, IOException, NetworkUnavailableException, HttpStatusException {
        ...
        if (!bundle3.isEmpty()) {
            ...
            for (String str222 : bundle3.keySet()) {
                i++;
                byteArrayOutputStream.write(getBytesUTF8("Content-Disposition: form-data; name=\"" + str222 + "\"; filename=\"" + "value.file" + C0201h.f514f + "\r\n"));
        ...
        if (size == Downloads.STATUS_SUCCESS) {
            return new Statistic(m2195a(execute), i);
        }
        throw new HttpStatusException(HttpStatusException.ERROR_INFO + size);
    }

    private static String m2195a(HttpResponse httpResponse) throws IllegalStateException, IOException {
    ...
    public static JSONObject parseJson(String str) throws JSONException {
        ...
        if (str.contains("online[0]=")) {
            str = "{online:" + str.charAt(str.length() - 2) + C0201h.f512d;
        }
    ...
    public static String getUserIp() {
        try {
            ...
            com.tencent.open.p067a.ProGuard.m2115a("openSDK_LOG.Util", "getUserIp SocketException ", e);
        }
        return Constants.STR_EMPTY;
    }
    ...
    private static boolean m2197a(Context context) {
        try {
            ...
            try {
                ...
                com.tencent.open.p067a.ProGuard.m2122e("openSDK_LOG.Util", "isQQBrowerAvailable has exception: " + e.getMessage());
                return false;
            }
    ...
    public static boolean openBrowser(Context context, String str) {
        ...
        try {
            ...
            if (a) {
                try {
                    m2196a(context, "com.tencent.mtt", "com.tencent.mtt.MainActivity", str);
                } catch (Exception e) {
                    if (a) {
                        try {
                            m2196a(context, "com.android.browser", "com.android.browser.BrowserActivity", str);
                        } catch (Exception e2) {
                            try {
                                m2196a(context, "com.google.android.browser", "com.android.browser.BrowserActivity", str);
                            } catch (Exception e3) {
                                try {
                                    m2196a(context, "com.android.chrome", "com.google.android.apps.chrome.Main", str);
                                } catch (Exception e4) {
                                    return false;
                                }
                            }
    ...
    private static void m2196a(Context context, String str, String str2, String str3) {
    ...
    public static boolean isMobileQQSupportShare(Context context) {
        try {
            ...
            com.tencent.open.p067a.ProGuard.m2118b("openSDK_LOG.Util", "NameNotFoundException", e);
            return false;
        }
    }
    ...
    public static String encrypt(String str) {
        try {
            ...
            if (digest != null) {
                StringBuilder stringBuilder = new StringBuilder();
                for (int i : digest) {
                    stringBuilder.append(m2194a(i >>> 4));
                    stringBuilder.append(m2194a(i));
                }
                str = stringBuilder.toString();
            }
        } catch (NoSuchAlgorithmException e) {
            com.tencent.open.p067a.ProGuard.m2122e("openSDK_LOG.Util", "encrypt has exception: " + e.getMessage());
        }
        return str;
    }

    private static char m2194a(int i) {
        int i2 = i & 15;
        if (i2 < 10) {
            return (char) (i2 + 48);
        }
    ...
    public static void reportBernoulli(Context context, String str, long j, String str2) {
        ...
        new ProGuard(context, bundle).start();
    }
    ...
    public static String toHexString(String str) {
        ...
        for (int i = 0; i < bytesUTF8.length; i++) {
            stringBuilder.append(f1749g.charAt((bytesUTF8[i] & 240) >> 4));
            stringBuilder.append(f1749g.charAt((bytesUTF8[i] & 15) >> 0));
        }
        return stringBuilder.toString();
    }
    ...
    public static String hexToString(String str) {
        ...
        while (i < bArr.length) {
            try {
                ...
                com.tencent.open.p067a.ProGuard.m2122e("openSDK_LOG.Util", "hexToString has exception: " + e.getMessage());
            }
            i++;
        }
        try {
            ...
            com.tencent.open.p067a.ProGuard.m2122e("openSDK_LOG.Util", "hexToString has exception: " + e2.getMessage());
            return str;
        }
    }
    ...
    public static String getAppVersion(Context context) {
        try {
            ...
            com.tencent.open.p067a.ProGuard.m2122e("openSDK_LOG.Util", "getAppVersion error" + e.getMessage());
            return Constants.STR_EMPTY;
        }
    }
    ...
    public static final String subString(String str, int i, String str2, String str3) {
        ...
        String str4 = AsyncHttpResponseHandler.DEFAULT_CHARSET;
    ...
    public static Bundle composeViaReportParams(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12) {
        ...
        bundle.putString(C0203j.f519c, str6);
    ...
    public static Bundle composeHaboCgiReportParams(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9) {
        ...
        bundle.putString(C0203j.f519c, str);
        ...
        bundle.putString("network", com.tencent.open.p068b.ProGuard.m2134a(Global.getContext()));
        bundle.putString("apn", com.tencent.open.p068b.ProGuard.m2135b(Global.getContext()));
    ...
    public static String getLocation(Context context) {
        ...
        try {
            ...
            if (bestProvider != null) {
                ...
                f1748f = latitude + "*" + lastKnownLocation.getLongitude();
                return f1748f;
            }
        } catch (Throwable e) {
            com.tencent.open.p067a.ProGuard.m2118b("openSDK_LOG.Util", "getLocation>>>", e);
        }
        return Constants.STR_EMPTY;
    }
    ...
    public static void getPackageInfo(Context context, String str) {
        if (context != null) {
            try {
                ...
                f1744b = packageInfo.versionName;
                f1743a = f1744b.substring(0, f1744b.lastIndexOf(46));
                f1746d = f1744b.substring(f1744b.lastIndexOf(46) + 1, f1744b.length());
                f1747e = packageInfo.versionCode;
            } catch (NameNotFoundException e) {
                com.tencent.open.p067a.ProGuard.m2122e("openSDK_LOG.Util", "getPackageInfo has exception: " + e.getMessage());
            } catch (Exception e2) {
                com.tencent.open.p067a.ProGuard.m2122e("openSDK_LOG.Util", "getPackageInfo has exception: " + e2.getMessage());
            }
        }
    }
    ...
    public static String getQUA3(Context context, String str) {
        ...
        f1745c = getAppVersionName(context, str);
        return f1745c;
    }
