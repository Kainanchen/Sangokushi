...
public class SystemUtils {
    ...
    public static boolean isAppSignatureValid(Context context, String str, String str2) {
        ProGuard.m2114a("openSDK_LOG.SystemUtils", "OpenUi, validateAppSignatureForPackage");
        try {
    ...
    public static String getAppSignatureMD5(Context context, String str) {
        String packageName;
        Throwable e;
        ProGuard.m2114a("openSDK_LOG.SystemUtils", "OpenUi, getSignValidString");
        ...
        try {
            ...
            instance.reset();
            ProGuard.m2114a("openSDK_LOG.SystemUtils", "-->sign: " + toHexString);
            instance.update(Util.getBytesUTF8(packageName + "_" + toHexString + "_" + str + Constants.STR_EMPTY));
            packageName = Util.toHexString(instance.digest());
            try {
                instance.reset();
                ProGuard.m2114a("openSDK_LOG.SystemUtils", "-->signEncryped: " + packageName);
            } catch (Exception e2) {
                e = e2;
                e.printStackTrace();
                ProGuard.m2118b("openSDK_LOG.SystemUtils", "OpenUi, getSignValidString error", e);
                return packageName;
            }
        } catch (Throwable e3) {
            Throwable th = e3;
    ...
    public static boolean checkMobileQQ(Context context) {
        ...
        try {
            ...
            ProGuard.m2118b("openSDK_LOG.SystemUtils", "checkMobileQQ NameNotFoundException", e);
            e.printStackTrace();
            packageInfo = null;
        }
        if (packageInfo == null) {
        ...
        try {
            ProGuard.m2117b("MobileQQ verson", str);
            String[] split = str.split("\\.");
            ...
            ProGuard.m2118b("openSDK_LOG.SystemUtils", "checkMobileQQ Exception", e2);
            e2.printStackTrace();
            return false;
        }
    }
    ...
    public static boolean extractSecureLib(String str, String str2, int i) {
        ...
        ProGuard.m2120c("openSDK_LOG.SystemUtils", "-->extractSecureLib, libName: " + str);
        Context context = Global.getContext();
        if (context == null) {
            ProGuard.m2120c("openSDK_LOG.SystemUtils", "-->extractSecureLib, global context is null. ");
            return false;
        }
        ...
        if (file.exists()) {
            ...
            ProGuard.m2120c("openSDK_LOG.SystemUtils", "-->extractSecureLib, libVersion: " + i + " | oldVersion: " + i2);
            if (i == i2) {
                return true;
            }
        }
        ...
        try {
            ...
            try {
                ...
                e = e5;
                try {
                    ProGuard.m2118b("openSDK_LOG.SystemUtils", "-->extractSecureLib, when copy lib execption.", e);
                    if (open != null) {
                        try {
                            open.close();
    ...
    public static boolean isLibExtracted(String str, int i) {
        Context context = Global.getContext();
        if (context == null) {
            ProGuard.m2120c("openSDK_LOG.SystemUtils", "-->isSecureLibExtracted, global context is null. ");
            return false;
        }
    ...
    private static long m2191a(InputStream inputStream, OutputStream outputStream) throws IOException {
        long j = 0;
        ...
        while (true) {
            ...
            if (read != -1) {
                ...
                ProGuard.m2120c("openSDK_LOG.SystemUtils", "-->copy, copyed size is: " + j);
                return j;
            }
        }
    }
