package com.tencent.open.p068b;
...
public class ProGuard extends SQLiteOpenHelper {
    protected static final String[] f1661a;
    protected static ProGuard f1662b;

    static {
        f1661a = new String[]{"key"};
    }

    public static synchronized ProGuard m2152a() {
        ProGuard proGuard;
        synchronized (ProGuard.class) {
            if (f1662b == null) {
                f1662b = new ProGuard(Global.getContext());
            }
            proGuard = f1662b;
        }
        return proGuard;
    ...
    public synchronized java.util.List<java.io.Serializable> m2153a(java.lang.String r12) {
        /*
        r11 = this;
        r9 = 0;
        monitor-enter(r11);
    ...
    L_0x001c:
        ...
        r3 = "type = ?";
        r4 = 1;
        r4 = new java.lang.String[r4];	 Catch:{ Exception -> 0x00de, all -> 0x00b8 }
        r5 = 0;
        r4[r5] = r12;	 Catch:{ Exception -> 0x00de, all -> 0x00b8 }
        r5 = 0;
        r6 = 0;
        r7 = 0;
        r3 = r0.query(r1, r2, r3, r4, r5, r6, r7);	 Catch:{ Exception -> 0x00de, all -> 0x00b8 }
    ...
    L_0x003a:
        ...
        r1 = r2.readObject();	 Catch:{ Exception -> 0x00e3, all -> 0x00e1 }
        r1 = (java.io.Serializable) r1;	 Catch:{ Exception -> 0x00e3, all -> 0x00e1 }
    ...
    L_0x0092:
        ...
        r2 = r3;
    L_0x0094:
        r3 = "openSDK_LOG.ReportDatabaseHelper";
        r4 = "getReportItemFromDB has exception.";
        com.tencent.open.p067a.ProGuard.m2118b(r3, r4, r1);	 Catch:{ all -> 0x00db }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void m2154a(java.lang.String r9, java.util.List<java.io.Serializable> r10) {
        /*
        r8 = this;
        r2 = 0;
        r1 = 20;
    ...
    L_0x007d:
        ...
        com.tencent.open.p067a.ProGuard.m2122e(r0, r1);	 Catch:{ all -> 0x009f }
    ...
    public synchronized void m2155b(String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (writableDatabase != null) {
                try {
                    ...
                    com.tencent.open.p067a.ProGuard.m2118b("openSDK_LOG.ReportDatabaseHelper", "clearReportItem has exception.", e);
                    if (writableDatabase != null) {
                        writableDatabase.close();
                    }
                } catch (Throwable th) {
