...
public abstract class BaseApi {
    ...
    public class TempRequestListener implements IRequestListener {
        ...
        class ProGuard extends Handler {
            ...
            ProGuard(Looper looper, BaseApi baseApi) {
        ...
        public TempRequestListener(IUiListener iUiListener) {
            ...
            this.mHandler = new ProGuard(Global.getContext().getMainLooper(), BaseApi.this);
        }
    ...
    protected void handleDownloadLastestQQ(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ProGuard.m2120c(TAG, "--handleDownloadLastestQQ");
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(ServerSetting.DOWNLOAD_QQ_URL);
        stringBuilder.append(Util.encodeUrl(bundle));
        Context context = activity;
        new TDialog(context, Constants.STR_EMPTY, stringBuilder.toString(), null, this.mToken).show();
    }
