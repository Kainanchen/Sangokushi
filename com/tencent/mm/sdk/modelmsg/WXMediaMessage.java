...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            try {
                ...
                e.printStackTrace();
                C0589b.m2018b(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e.getMessage());
                return wXMediaMessage;
            }
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            C0589b.m2018b(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }
        ...
        private static String pathOldToNew(String str) {
            ...
            C0589b.m2018b(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
            return str;
        }
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            e.printStackTrace();
            C0589b.m2018b(TAG, "put thumb failed");
        }
    }
}
