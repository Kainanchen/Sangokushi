...
import com.tencent.mm.sdk.p063b.C0587a;
...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C0587a.m2012b(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C0587a.m2011a(bundle, "_wxapi_payoptions_callback_flags");
        }
    ...
    public boolean checkArgs() {
        if (this.appId == null || this.appId.length() == 0) {
            C0589b.m2018b(TAG, "checkArgs fail, invalid appId");
            return false;
        } else if (this.partnerId == null || this.partnerId.length() == 0) {
            C0589b.m2018b(TAG, "checkArgs fail, invalid partnerId");
            return false;
        } else if (this.prepayId == null || this.prepayId.length() == 0) {
            C0589b.m2018b(TAG, "checkArgs fail, invalid prepayId");
            return false;
        } else if (this.nonceStr == null || this.nonceStr.length() == 0) {
            C0589b.m2018b(TAG, "checkArgs fail, invalid nonceStr");
            return false;
        } else if (this.timeStamp == null || this.timeStamp.length() == 0) {
            C0589b.m2018b(TAG, "checkArgs fail, invalid timeStamp");
            return false;
        } else if (this.packageValue == null || this.packageValue.length() == 0) {
            C0589b.m2018b(TAG, "checkArgs fail, invalid packageValue");
            return false;
        } else if (this.sign == null || this.sign.length() == 0) {
            C0589b.m2018b(TAG, "checkArgs fail, invalid sign");
            return false;
        } else if (this.extData == null || this.extData.length() <= EXTDATA_MAX_LENGTH) {
            return true;
        } else {
            C0589b.m2018b(TAG, "checkArgs fail, extData length too long");
            return false;
        }
    }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C0587a.m2012b(bundle, "_wxapi_payreq_appid");
        this.partnerId = C0587a.m2012b(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C0587a.m2012b(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C0587a.m2012b(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C0587a.m2012b(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C0587a.m2012b(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C0587a.m2012b(bundle, "_wxapi_payreq_sign");
        this.extData = C0587a.m2012b(bundle, "_wxapi_payreq_extdata");
        this.signType = C0587a.m2012b(bundle, "_wxapi_payreq_sign_type");
