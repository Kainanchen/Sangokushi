...
final class C0608f extends AsyncTask<Void, Void, C0607a> {
    ...
    static class C0607a {
        ...
        public static com.tencent.mm.sdk.diffdev.p065a.C0608f.C0607a m2045e(byte[] r9) {
            /*
            r8 = 1;
            r7 = 0;
    ...
    public C0608f(String str, OAuthListener oAuthListener) {
        this.aq = str;
    ...
    protected final /* synthetic */ Object doInBackground(Object[] objArr) {
        if (this.aq == null || this.aq.length() == 0) {
            ...
            c0607a.ap = OAuthErrCode.WechatAuth_Err_NormalErr;
            return c0607a;
        }
        while (!isCancelled()) {
            String str = this.url + (this.aw == 0 ? Constants.STR_EMPTY : "&last=" + this.aw);
            long currentTimeMillis = System.currentTimeMillis();
            byte[] b = C0606e.m2044b(str, 60000);
            long currentTimeMillis2 = System.currentTimeMillis();
            c0607a = C0607a.m2045e(b);
            Log.d("MicroMsg.SDK.NoopingTask", String.format("nooping, url = %s, errCode = %s, uuidStatusCode = %d, time consumed = %d(ms)", new Object[]{str, c0607a.ap.toString(), Integer.valueOf(c0607a.ay), Long.valueOf(currentTimeMillis2 - currentTimeMillis)}));
            if (c0607a.ap == OAuthErrCode.WechatAuth_Err_OK) {
                this.aw = c0607a.ay;
                if (c0607a.ay == C0609g.UUID_SCANED.getCode()) {
                    this.an.onQrcodeScanned();
                } else if (c0607a.ay != C0609g.UUID_KEEP_CONNECT.getCode() && c0607a.ay == C0609g.UUID_CONFIRM.getCode()) {
                    if (c0607a.ax != null && c0607a.ax.length() != 0) {
                        return c0607a;
                    }
            ...
            Log.e("MicroMsg.SDK.NoopingTask", String.format("nooping fail, errCode = %s, uuidStatusCode = %d", new Object[]{c0607a.ap.toString(), Integer.valueOf(c0607a.ay)}));
            return c0607a;
        }
        Log.i("MicroMsg.SDK.NoopingTask", "IDiffDevOAuth.stopAuth / detach invoked");
        c0607a = new C0607a();
        c0607a.ap = OAuthErrCode.WechatAuth_Err_Auth_Stopped;
        return c0607a;
    }

    protected final /* synthetic */ void onPostExecute(Object obj) {
        C0607a c0607a = (C0607a) obj;
        this.an.onAuthFinish(c0607a.ap, c0607a.ax);
    }
}
