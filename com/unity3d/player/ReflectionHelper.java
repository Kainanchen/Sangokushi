...
final class ReflectionHelper {
    ...
    static class C06691 implements InvocationHandler {
        ...
        protected final void finalize() {
            try {
                ReflectionHelper.nativeProxyFinalize(this.f2126a);
            } finally {
                super.finalize();
            }
        }
        ...
        public final Object invoke(Object obj, Method method, Object[] objArr) {
            return ReflectionHelper.nativeProxyInvoke(this.f2126a, method.getName(), objArr);
        }
    }

    /* renamed from: com.unity3d.player.ReflectionHelper.a */
    private static class C0670a {
        public volatile Member f2128a;
        private final Class f2129b;
        private final String f2130c;
        private final String f2131d;
        private final int f2132e;

        C0670a(Class cls, String str, String str2) {
            this.f2129b = cls;
            this.f2130c = str;
            this.f2131d = str2;
            this.f2132e = ((((this.f2129b.hashCode() + 527) * 31) + this.f2130c.hashCode()) * 31) + this.f2131d.hashCode();
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return this.f2132e == c0670a.f2132e && this.f2131d.equals(c0670a.f2131d) && this.f2130c.equals(c0670a.f2130c) && this.f2129b.equals(c0670a.f2129b);
        }
    ...
    static {
        LOG = false;
        f2133a = new C0670a[AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD];
    }

    ReflectionHelper() {
    }

    private static float m2477a(Class cls, Class cls2) {
        if (cls.equals(cls2)) {
    ...
    private static float m2478a(Class cls, Class[] clsArr, Class[] clsArr2) {
        int i = 0;
        if (clsArr2.length == 0) {
            return 0.1f;
        }
        ...
        if (clsArr != null) {
            ...
            while (i < clsArr.length) {
                f *= m2477a(clsArr[i], clsArr2[i2]);
                i++;
                i2++;
            }
        }
        return f * m2477a(cls, clsArr2[clsArr2.length - 1]);
    }

    private static Class m2479a(String str, int[] iArr) {
        while (iArr[0] < str.length()) {
            ...
            if (charAt != '(' && charAt != ')') {
                if (charAt == 'L') {
                    ...
                    if (charAt == '[') {
                        return Array.newInstance(m2479a(str, iArr), 0).getClass();
                    }
                    C0708m.Log(5, "! parseType; " + charAt + " is not known!");
                }
                return null;
            }
        }
    ...
    private static void m2482a(C0670a c0670a, Member member) {
        c0670a.f2128a = member;
        f2133a[c0670a.hashCode() & (f2133a.length - 1)] = c0670a;
    }

    private static boolean m2483a(C0670a c0670a) {
        C0670a c0670a2 = f2133a[c0670a.hashCode() & (f2133a.length - 1)];
        if (!c0670a.equals(c0670a2)) {
            return false;
        }
        c0670a.f2128a = c0670a2.f2128a;
        return true;
    }

    private static Class[] m2484a(String str) {
        int[] iArr = new int[]{0};
        ArrayList arrayList = new ArrayList();
        while (iArr[0] < str.length()) {
            Class a = m2479a(str, iArr);
            if (a == null) {
                break;
            }
            arrayList.add(a);
    ...
    protected static Constructor getConstructorID(Class cls, String str) {
        Member member = null;
        C0670a c0670a = new C0670a(cls, Constants.STR_EMPTY, str);
        if (m2483a(c0670a)) {
            Constructor constructor = (Constructor) c0670a.f2128a;
        } else {
            Member member2;
            Class[] a = m2484a(str);
            float f = 0.0f;
            ...
            while (i < length) {
                ...
                float a2 = m2478a(Void.TYPE, member2.getParameterTypes(), a);
                if (a2 > f) {
    ...
    protected static Object newProxyInstance(int i, Class[] clsArr) {
        return Proxy.newProxyInstance(ReflectionHelper.class.getClassLoader(), clsArr, new C06691(i, clsArr));
    }
}
