...
class UnityWebRequest implements Runnable {
    private static final String[] f2223e;
    private static volatile SSLSocketFactory f2224f;
    private long f2225a;
    ...
    static {
        f2223e = new String[]{"TLSv1.2", "TLSv1.1"};
    }
        ...
        synchronized (f2223e) {
            ...
            while (i < length) {
                ...
                try {
                    ...
                    f2224f = socketFactory;
                    return socketFactory;
                } catch (Exception e) {
                    C0708m.Log(5, "UnityWebRequest: No support for " + str + " (" + e.getMessage() + ")");
                    i++;
                }
            }
            return null;
    ...
    protected void malformattedUrlCallback(String str) {
        errorCallback(this.f2225a, 5, str);
    }

    protected void responseCodeCallback(int i) {
        responseCodeCallback(this.f2225a, i);
    }

    public void run() {
        try {
            URL url = new URL(this.f2226b);
            ...
            if (url.getProtocol().equalsIgnoreCase("file") && !url.getHost().isEmpty()) {
                ...
                if (openConnection instanceof HttpURLConnection) {
                    try {
                        ...
                        httpURLConnection.setRequestMethod(this.f2227c);
                ...
                if (this.f2228d != null) {
                    for (Entry entry : this.f2228d.entrySet()) {
                ...
                if ((headerFields == null || !headerFields.containsKey(C0182d.f422d)) && openConnection.getContentType() != null) {
                    headerCallback(C0182d.f422d, openConnection.getContentType());
                }
                ...
                if (url.getProtocol().equalsIgnoreCase("file")) {
                    min = uploadCallback == 0 ? WXMediaMessage.THUMB_LENGTH_LIMIT : Math.min(uploadCallback, WXMediaMessage.THUMB_LENGTH_LIMIT);
                } else {
                    min = 1428;
                }
                try {
    ...
    protected void sslCannotConnectCallback(String str) {
        errorCallback(this.f2225a, 16, str);
    }

    protected void unknownHostCallback(String str) {
        errorCallback(this.f2225a, 7, str);
    }

    protected int uploadCallback(ByteBuffer byteBuffer) {
        return uploadCallback(this.f2225a, byteBuffer);
    }
}
