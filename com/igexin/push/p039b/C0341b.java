...
public class C0341b extends SQLiteOpenHelper {
    SQLiteDatabase f910a;
    ...
    private String m1145a(String[] strArr, String[] strArr2, int i) {
        int i2 = 0;
    ...
    public android.database.Cursor m1146a(java.lang.String r10, java.lang.String[] r11, java.lang.String[] r12, java.lang.String[] r13, java.lang.String r14) {
        /*
        r9 = this;
        r1 = 1;
        r8 = 0;
    ...
    L_0x000f:
        r0 = r9.f910a;	 Catch:{ Exception -> 0x0074, all -> 0x007c }
        r3 = 0;
        r4 = 0;
        r5 = 0;
        r6 = 0;
    ...
    L_0x001c:
        r1 = r9.f910a;	 Catch:{ Exception -> 0x0083, all -> 0x007c }
    ...
    L_0x0050:
        ...
        r3 = r9.m1145a(r11, r12, r1);	 Catch:{ Exception -> 0x0074, all -> 0x007c }
        r4 = 0;
        r5 = 0;
        r6 = 0;
        r1 = r10;
    ...
    public void m1147a(String str, ContentValues contentValues) {
        this.f910a = getWritableDatabase();
        this.f910a.beginTransaction();
        try {
            this.f910a.insert(str, null, contentValues);
            this.f910a.setTransactionSuccessful();
        } catch (Exception e) {
        } finally {
            this.f910a.endTransaction();
        }
    }

    public void m1148a(String str, ContentValues contentValues, String[] strArr, String[] strArr2) {
        this.f910a = getWritableDatabase();
        this.f910a.beginTransaction();
        if (strArr == null) {
            try {
                this.f910a.update(str, contentValues, null, null);
            } catch (Exception e) {
                this.f910a.endTransaction();
                return;
            } catch (Throwable th) {
            ...
            this.f910a.update(str, contentValues, m1145a(strArr, strArr2, strArr.length), null);
        } else if (strArr2.length == 1) {
            this.f910a.update(str, contentValues, strArr[0] + "='" + strArr2[0] + "'", null);
        } else {
            this.f910a.update(str, contentValues, m1145a(strArr, strArr2, strArr2.length), null);
        }
        this.f910a.setTransactionSuccessful();
        this.f910a.endTransaction();
    }

    public void m1149a(String str, String str2) {
        this.f910a = getWritableDatabase();
        this.f910a.beginTransaction();
        try {
            this.f910a.delete(str, str2, null);
            this.f910a.setTransactionSuccessful();
        } catch (Exception e) {
        } finally {
            this.f910a.endTransaction();
