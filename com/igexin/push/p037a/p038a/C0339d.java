...
public class C0339d implements C0335d {
    private long f904a;
    ...
    public void m1137a() {
        ...
        r0 = com.igexin.push.core.C0483g.f1327m;	 Catch:{ Exception -> 0x01e6, all -> 0x01df }
        if (r0 == 0) goto L_0x000f;
    L_0x000c:
        r12 = 1800000; // 0x1b7740 float:2.522337E-39 double:8.89318E-318;
    L_0x000f:
        r0 = com.igexin.push.core.C0483g.f1323i;	 Catch:{ Exception -> 0x01e6, all -> 0x01df }
    ...
    L_0x0016:
        ...
        r0 = com.igexin.push.core.C0482f.m1694a();	 Catch:{ Exception -> 0x01e6, all -> 0x01df }
        r0 = r0.m1716k();	 Catch:{ Exception -> 0x01e6, all -> 0x01df }
        r1 = "bi";
        r2 = 1;
        ...
        r4 = 0;
        r5 = 0;
        r6 = r0.m1146a(r1, r2, r3, r4, r5);	 Catch:{ Exception -> 0x01e6, all -> 0x01df }
    ...
    L_0x0071:
        ...
        r2 = "1";
        r0.put(r1, r2);	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        r1 = com.igexin.push.core.C0482f.m1694a();	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        r1 = r1.m1716k();	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        r2 = "bi";
        r1.m1147a(r2, r0);	 Catch:{ Exception -> 0x0168, all -> 0x01df }
    L_0x0093:
    ...
    L_0x0098:
        ...
        r2 = com.igexin.push.core.C0483g.f1300L;
        r0 = r0 - r2;
    ...
    L_0x00a9:
        r0 = com.igexin.push.core.p045a.C0402e.m1330a();
        r1 = 0;
        r2 = 0;
        r0 = r0.m1346a(r1, r2);
        if (r0 == 0) goto L_0x00da;
    ...
    L_0x00bd:
        ...
        r2.<init>(r3, r0, r4, r5);
        r1.<init>(r2);
        r0 = com.igexin.p022a.p023a.p027b.C0244d.m802c();
        r2 = 0;
        r3 = 1;
        r0.m795a(r1, r2, r3);
    L_0x00da:
    ...
    L_0x0136:
        ...
        r8.put(r10, r11);	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        r10 = com.igexin.push.core.C0482f.m1694a();	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        r10 = r10.m1716k();	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        r11 = "bi";
        r12 = 1;
        ...
        r10.m1148a(r11, r8, r12, r13);	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        goto L_0x00db;
    L_0x0168:
        r0 = move-exception;
        r0 = r6;
    ...
    L_0x01bb:
        ...
        r10 = "1";
        r8.put(r9, r10);	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        r9 = com.igexin.push.core.C0482f.m1694a();	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        r9 = r9.m1716k();	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        r10 = "bi";
        r9.m1147a(r10, r8);	 Catch:{ Exception -> 0x0168, all -> 0x01df }
        goto L_0x00db;
    L_0x01df:
        r0 = move-exception;
    ...
    public void m1138a(long j) {
        this.f904a = j;
    }

    public boolean m1139b() {
        return System.currentTimeMillis() - this.f904a > 1800000;
    }
}
