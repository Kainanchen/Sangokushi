...
public class C0267h {
    public static Random f716a;
    private static final Pattern f717b;

    static {
        f716a = new Random(SystemClock.uptimeMillis());
        f717b = Pattern.compile("attachment;\\s*filename\\s*=\\s*\"([^\"]*)\"");
    }

    public static C0260a m936a(Context context, String str, String str2, String str3, String str4, String str5, int i, int i2) {
        String a;
        String str6;
        int indexOf;
        String a2 = C0267h.m939a(str, str2, str3, str4, i);
        int indexOf2 = a2.indexOf(46);
        if (indexOf2 < 0) {
            a = C0267h.m940a(str5, true);
            str6 = a2;
        } else {
            a = C0267h.m938a(str5, i, a2, indexOf2);
        ...
        if (!Environment.getExternalStorageState().equals("mounted")) {
            return new C0260a(null, null, Downloads.STATUS_FILE_ERROR);
        }
        String path = Environment.getExternalStorageDirectory().getPath();
        File file = new File(path + SdkDownLoader.f698b);
        if (!file.isDirectory()) {
            String[] split = SdkDownLoader.f698b.split("/");
            indexOf = 0;
        ...
        a2 = C0267h.m937a(i, file.getPath() + File.separator + str6, a, "recovery".equalsIgnoreCase(str6 + a));
        return a2 != null ? new C0260a(a2, new FileOutputStream(a2), 0) : new C0260a(null, null, Downloads.STATUS_FILE_ERROR);
    }

    private static String m937a(int i, String str, String str2, boolean z) {
        int i2 = 1;
    ...
    private static java.lang.String m938a(java.lang.String r3, int r4, java.lang.String r5, int r6) {
        /*
        r0 = 0;
    ...
    L_0x001f:
        r0 = 0;
        r0 = com.igexin.download.C0267h.m940a(r3, r0);
    ...
    private static String m939a(String str, String str2, String str3, String str4, int i) {
        String decode;
        int lastIndexOf;
        String str5 = null;
    ...
    private static String m940a(String str, boolean z) {
        String str2 = null;
        if (str != null) {
    ...
    private static void m941a(C0268i c0268i) {
        while (true) {
            if (c0268i.m952a() == 1) {
                c0268i.m953b();
                C0267h.m941a(c0268i);
    ...
    public static void m942a(String str, Set set) {
        if (str != null) {
            try {
                C0268i c0268i = new C0268i(str, set);
                C0267h.m941a(c0268i);
                if (c0268i.m952a() != 9) {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final boolean m944a(android.content.Context r11, long r12) {
        /*
        r8 = 0;
        r6 = 0;
        r7 = 0;
        r0 = r11.getContentResolver();	 Catch:{ Exception -> 0x0076, all -> 0x006b }
        r1 = com.igexin.download.Downloads.f695a;	 Catch:{ Exception -> 0x0076, all -> 0x006b }
        r2 = 0;
    ...
    L_0x0028:
        ...
        r7 = com.igexin.download.Downloads.f695a;	 Catch:{ Exception -> 0x005c, all -> 0x0072 }
    ...
    public static boolean m945a(String str) {
    ...
    private static String m946b(String str) {
        try {
            Matcher matcher = f717b.matcher(str);
            if (matcher.find()) {
    ...
    private static void m947b(C0268i c0268i) {
        if (c0268i.m952a() != 4) {
    ...
    public static boolean m948b(Context context) {
        ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
        if (connectivityManager != null) {
    ...
    public static boolean m949c(Context context) {
        ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
        if (connectivityManager != null) {
            NetworkInfo activeNetworkInfo = connectivityManager.getActiveNetworkInfo();
