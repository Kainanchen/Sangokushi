...
public final class Downloads implements BaseColumns {
    ...
    public static boolean isStatusClientError(int i) {
        return i >= STATUS_BAD_REQUEST && i < 500;
    }

    public static boolean isStatusCompleted(int i) {
        return (i >= STATUS_SUCCESS && i < 300) || (i >= STATUS_BAD_REQUEST && i < 600);
    }

    public static boolean isStatusError(int i) {
        return i >= STATUS_BAD_REQUEST && i < 600;
    }
    ...
    public static void setContentUrl(String str) {
        authority = str;
        f695a = Uri.parse("content://" + str + "/download");
        f696b = Uri.parse("content://" + str + "/download/full/item");
    }
}
