...
class C0268i {
    ...
    public C0268i(String str, Set set) {
        this.f720c = 0;
        this.f721d = 0;
        this.f718a = str;
        this.f719b = set;
        this.f722e = new char[this.f718a.length()];
        this.f718a.getChars(0, this.f722e.length, this.f722e, 0);
        m953b();
    }

    private static final boolean m950a(char c) {
        return c == '_' || ((c >= 'A' && c <= 'Z') || (c >= 'a' && c <= 'z'));
    }

    private static final boolean m951b(char c) {
    ...
    L_0x00f4:
        r1 = r8.f720c;
        r1 = r0[r1];
        r1 = com.igexin.download.C0268i.m950a(r1);
    ...
    L_0x010b:
        r2 = r8.f720c;
        r2 = r0[r2];
        r2 = com.igexin.download.C0268i.m951b(r2);
