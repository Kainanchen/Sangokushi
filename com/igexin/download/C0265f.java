...
class C0265f extends Thread {
    final /* synthetic */ DownloadService f713a;

    public C0265f(DownloadService downloadService) {
        this.f713a = downloadService;
    ...
    L_0x000d:
        ...
        monitor-enter(r3);
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ all -> 0x0026 }
        r2 = r2.f688d;	 Catch:{ all -> 0x0026 }
        r0 = r22;
    ...
    L_0x0029:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ all -> 0x0026 }
        r2 = r2.f689e;	 Catch:{ all -> 0x0026 }
        if (r2 != 0) goto L_0x009a;
    L_0x0033:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ all -> 0x0026 }
        r4 = 0;
        r2.f688d = r4;	 Catch:{ all -> 0x0026 }
    ...
    L_0x005b:
        ...
        r2 = r0.f713a;	 Catch:{ all -> 0x0026 }
        r4 = 0;
        r2.f693i = r4;	 Catch:{ all -> 0x0026 }
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ all -> 0x0026 }
        r4 = 0;
        r2.f694j = r4;	 Catch:{ all -> 0x0026 }
        monitor-exit(r3);	 Catch:{ all -> 0x0026 }
    L_0x006c:
        return;
    L_0x006d:
    ...
    L_0x009a:
        ...
        r2 = r0.f713a;	 Catch:{ all -> 0x0026 }
        r4 = 0;
        r2.f689e = r4;	 Catch:{ all -> 0x0026 }
        monitor-exit(r3);	 Catch:{ all -> 0x0026 }
        r0 = r22;
        r2 = r0.f713a;
        r14 = com.igexin.download.C0267h.m943a(r2);
        r0 = r22;
        r2 = r0.f713a;
        r15 = com.igexin.download.C0267h.m949c(r2);
        r8 = java.lang.System.currentTimeMillis();
        r13 = 0;
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x02e8, all -> 0x02e5 }
        r2 = r2.getContentResolver();	 Catch:{ Exception -> 0x02e8, all -> 0x02e5 }
        r3 = com.igexin.download.Downloads.f695a;	 Catch:{ Exception -> 0x02e8, all -> 0x02e5 }
        r4 = 0;
        r5 = 0;
        r6 = 0;
        r7 = "_id";
    ...
    L_0x00ea:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2 = r2.f687c;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
    ...
    L_0x00fa:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2.m910b(r5);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        goto L_0x00e8;
    L_0x0102:
        r2 = move-exception;
    L_0x0103:
    ...
    L_0x0122:
        r0 = r22;
        r3 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r6 = r14;
        r7 = r15;
        r3.m899a(r4, r5, r6, r7, r8);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2 = r2.m919d(r5);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        if (r2 == 0) goto L_0x0314;
    L_0x0135:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2 = r2.m913b();	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        if (r2 == 0) goto L_0x0149;
    L_0x013f:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2 = r2.m904a(r4, r5);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        if (r2 != 0) goto L_0x0314;
    L_0x0149:
        r10 = 1;
        r11 = 1;
    ...
    L_0x014c:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2 = r2.m917c(r5);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
    ...
    L_0x0157:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r6 = r2.m892a(r5, r8);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r18 = 0;
    ...
    L_0x01a9:
        ...
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r6 = 0;
        r2.m904a(r6, r5);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
    L_0x01b1:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2.m910b(r5);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
    ...
    L_0x01bf:
        ...
        r6 = r14;
        r7 = r15;
        r3.m911b(r4, r5, r6, r7, r8);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2 = r2.m919d(r5);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
    ...
    L_0x0277:
        ...
        goto L_0x0262;
    L_0x0279:
        r2 = com.igexin.download.SdkDownLoader.f699c;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        if (r2 == 0) goto L_0x0299;
    L_0x027d:
        r2 = com.igexin.download.SdkDownLoader.f699c;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r0 = r22;
        r3 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r3 = r3.f687c;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2.m930a(r3);	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        ...
        r3 = com.igexin.download.SdkDownLoader.f699c;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r3 = r3.f700d;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
    ...
    L_0x029b:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2 = r2.f691g;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
    ...
    L_0x02a5:
        ...
        r3 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r5 = 1;
        r3.f691g = r5;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r0 = r22;
        r3 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r0 = r22;
        r5 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r5 = r5.f690f;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r6 = 1;
    ...
    L_0x02d2:
        r0 = r22;
        r2 = r0.f713a;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2 = r2.f690f;	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        r2.m931a();	 Catch:{ Exception -> 0x0102, all -> 0x02de }
        goto L_0x02c9;
    L_0x02de:
        r2 = move-exception;
    L_0x02df:
