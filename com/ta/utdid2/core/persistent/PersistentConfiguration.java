...
public class PersistentConfiguration {
    ...
    public PersistentConfiguration(Context context, String folderName, String configName, boolean isSafety, boolean isLessMode) {
        this.mConfigName = Constants.STR_EMPTY;
        this.mFolderName = Constants.STR_EMPTY;
    ...
    public String getString(String key) {
        checkSDCardXMLFile();
        if (this.mSp != null) {
            String value = this.mSp.getString(key, Constants.STR_EMPTY);
            if (!StringUtils.isEmpty(value)) {
                return value;
            }
        }
        if (this.mMySP != null) {
            return this.mMySP.getString(key, Constants.STR_EMPTY);
        }
