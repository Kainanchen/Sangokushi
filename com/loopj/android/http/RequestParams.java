...
public class RequestParams implements Serializable {
    ...
    class C05441 extends HashMap<String, String> {
        final /* synthetic */ String val$key;
        final /* synthetic */ String val$value;

        C05441(String str, String str2) {
            this.val$key = str;
            this.val$value = str2;
    ...
    public void setContentEncoding(String encoding) {
        if (encoding != null) {
            ...
            AsyncHttpClient.log.m1882d(LOG_TAG, "setContentEncoding called with null attribute");
        }
    }
    ...
    private HttpEntity createFormEntity() {
        try {
            ...
            AsyncHttpClient.log.m1885e(LOG_TAG, "createFormEntity failed", e);
            return null;
        }
    }
