            ...
            while (p < len) {
                if (state == 0) {
                    while (p + Base64.CRLF <= len) {
                        value = (((alphabet[input[p] & MotionEventCompat.ACTION_MASK] << 18) | (alphabet[input[p + Base64.NO_PADDING] & MotionEventCompat.ACTION_MASK] << 12)) | (alphabet[input[p + Base64.NO_WRAP] & MotionEventCompat.ACTION_MASK] << 6)) | alphabet[input[p + 3] & MotionEventCompat.ACTION_MASK];
                        if (value >= 0) {
