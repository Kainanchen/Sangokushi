...
class SimpleMultipartEntity implements HttpEntity {
    ...
    private class FilePart {
        ...
        private byte[] createHeader(String key, String filename, String type) {
            ...
            try {
                ...
                AsyncHttpClient.log.m1885e(SimpleMultipartEntity.LOG_TAG, "createHeader ByteArrayOutputStream exception", e);
            }
    ...
    public void addPart(String key, String value, String contentType) {
        try {
            ...
            AsyncHttpClient.log.m1885e(LOG_TAG, "addPart ByteArrayOutputStream exception", e);
        }
    }
    ...
    private byte[] createContentDisposition(String key) {
        return ("Content-Disposition: form-data; name=\"" + key + C0201h.f514f + STR_CR_LF).getBytes();
    }

    private byte[] createContentDisposition(String key, String fileName) {
        return ("Content-Disposition: form-data; name=\"" + key + C0201h.f514f + "; filename=\"" + fileName + C0201h.f514f + STR_CR_LF).getBytes();
    }
