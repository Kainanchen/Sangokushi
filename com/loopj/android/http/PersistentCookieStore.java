...
public class PersistentCookieStore implements CookieStore {
    ...
    protected String encodeCookie(SerializableCookie cookie) {
        ...
        try {
            ...
            AsyncHttpClient.log.m1883d(LOG_TAG, "IOException in encodeCookie", e);
            return null;
        }
    }
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            AsyncHttpClient.log.m1883d(LOG_TAG, "IOException in decodeCookie", e);
        } catch (ClassNotFoundException e2) {
            AsyncHttpClient.log.m1883d(LOG_TAG, "ClassNotFoundException in decodeCookie", e2);
        }
        return cookie;
    }
